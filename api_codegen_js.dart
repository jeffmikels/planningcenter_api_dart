...
void main(List<String> arguments) async {
  ...
  for (var app in applications) {
    ...
    for (var vertex in vertices.values) {
      ...
      // ========== JAVASCRIPT OUTPUT DIRECTORY ==================
      // ========== JAVASCRIPT OUTPUT DIRECTORY ==================
      var codeFilename = '$outputDir/$dirName/$basename';
    ...
    var f = File('$outputDir/$exportsFile');
  ...
  var constructorsFile = '$outputDir/pco_base/pco_constructors.js';
