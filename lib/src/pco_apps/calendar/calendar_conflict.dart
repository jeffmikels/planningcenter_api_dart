/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.803335
...
class PcoCalendarConflict extends PcoResource {
  ...
  List<T> includedResolvedBy<T extends PcoResource>() => relationships['resolved_by']?.cast<T>() ?? [];
  List<T> includedResource<T extends PcoResource>() => relationships['resource']?.cast<T>() ?? [];
  List<T> includedWinner<T extends PcoResource>() => relationships['winner']?.cast<T>() ?? [];
