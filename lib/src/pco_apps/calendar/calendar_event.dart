/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.804086
...
class PcoCalendarEvent extends PcoResource {
  ...
  List<T> includedAttachments<T extends PcoResource>() => relationships['attachments']?.cast<T>() ?? [];
  List<T> includedOwner<T extends PcoResource>() => relationships['owner']?.cast<T>() ?? [];
