...
enum PcoCalendarEventInstanceFilter { all, approved, approvedPending, approvedPendingRejected, approvedRejected, approver, approverSubscriber, future, lost, owner, ownerApprover, ownerApproverSubscriber, ownerSubscriber, pending, pendingRejected, rejected, shared, subscriber, unresolved }
...
class PcoCalendarEventInstanceQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCalendarEventInstanceOrder order, {bool reverse = false}) =>
  ...
  static final Map<PcoCalendarEventInstanceFilter, String> _filterMap = {
    ...
    PcoCalendarEventInstanceFilter.approvedPendingRejected: 'approved_pending_rejected',
    ...
    PcoCalendarEventInstanceFilter.ownerApproverSubscriber: 'owner_approver_subscriber',
  ...
  static String filterString(PcoCalendarEventInstanceFilter filter) => _filterMap[filter]!;
...
class PcoCalendarEventInstance extends PcoResource {
  ...
  List<PcoCalendarEventTime> get includedEventTimes => (relationships['event_times'] as List?)?.cast<PcoCalendarEventTime>() ?? [];
  List<PcoCalendarResourceBooking> get includedResourceBookings => (relationships['resource_bookings'] as List?)?.cast<PcoCalendarResourceBooking>() ?? [];
  List<PcoCalendarTag> get includedTags => (relationships['tags'] as List?)?.cast<PcoCalendarTag>() ?? [];

  // Class Constructors
  PcoCalendarEventInstance.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCalendarEventInstance({String? id, bool? isAllDayEvent, DateTime? createdAt, DateTime? endsAt, String? location, String? recurrence, String? recurrenceDescription, DateTime? startsAt, DateTime? updatedAt, String? churchCenterUrl, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (recurrenceDescription != null) obj._attributes['recurrence_description'] = recurrenceDescription;
    if (startsAt != null) obj._attributes['starts_at'] = startsAt.toIso8601String();
    if (updatedAt != null) obj._attributes['updated_at'] = updatedAt.toIso8601String();
    if (churchCenterUrl != null) obj._attributes['church_center_url'] = churchCenterUrl;
  ...
  static Future<PcoCollection<PcoCalendarEventInstance>> get( {String? id, PcoCalendarEventInstanceQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false, bool includeResourceBookings = false, bool includeTags = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarEventInstance>> getFromEvent(String eventId, {String? id, PcoCalendarEventInstanceQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false, bool includeResourceBookings = false, bool includeTags = false,}) async {
    query ??= PcoCalendarEventInstanceQuery();
    if (includeAll) query.include.addAll(PcoCalendarEventInstance.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarEventInstance>> getFromResourceBooking(String resourceBookingId, {PcoCalendarEventInstanceQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false, bool includeResourceBookings = false, bool includeTags = false,}) async {
    query ??= PcoCalendarEventInstanceQuery();
    if (includeAll) query.include.addAll(PcoCalendarEventInstance.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarEventInstance>> getFromTag(String tagId, {String? id, PcoCalendarEventInstanceQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false, bool includeResourceBookings = false, bool includeTags = false,}) async {
    query ??= PcoCalendarEventInstanceQuery();
    if (includeAll) query.include.addAll(PcoCalendarEventInstance.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  Future<PcoCollection<PcoCalendarEventTime>> getEventTimes({PcoCalendarEventTimeQuery? query}) async {
