/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.804679
...
class PcoCalendarEventInstance extends PcoResource {
  ...
  List<T> includedResourceBookings<T extends PcoResource>() => relationships['resource_bookings']?.cast<T>() ?? [];
  List<T> includedTags<T extends PcoResource>() => relationships['tags']?.cast<T>() ?? [];
