/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.805429
...
class PcoCalendarEventResourceRequest extends PcoResource {
  ...
  List<T> includedResource<T extends PcoResource>() => relationships['resource']?.cast<T>() ?? [];
  List<T> includedRoomSetup<T extends PcoResource>() => relationships['room_setup']?.cast<T>() ?? [];
