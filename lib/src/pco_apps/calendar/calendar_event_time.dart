/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.546152
...
class PcoCalendarEventTimeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCalendarEventTimeOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCalendarEventTimeFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCalendarEventTimeFilter filter) => _filterMap[filter]!;
  ...
  PcoCalendarEventTimeQuery({
    ...
    if (whereVisibleOnKiosks != null) where.add(PlanningCenterApiWhere.parse('visible_on_kiosks', whereVisibleOnKiosks));
    if (whereVisibleOnWidgetAndIcal != null) where.add(PlanningCenterApiWhere.parse('visible_on_widget_and_ical', whereVisibleOnWidgetAndIcal));
...
class PcoCalendarEventTime extends PcoResource {
  ...
  bool get isVisibleOnWidgetAndIcal => _attributes[kVisibleOnWidgetAndIcal] == true;
  ...
  // Class Constructors
  PcoCalendarEventTime.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCalendarEventTime({String? id, DateTime? endsAt, DateTime? startsAt, DateTime? name, bool? isVisibleOnKiosks, bool? isVisibleOnWidgetAndIcal, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isVisibleOnKiosks != null) obj._attributes['visible_on_kiosks'] = isVisibleOnKiosks;
    if (isVisibleOnWidgetAndIcal != null) obj._attributes['visible_on_widget_and_ical'] = isVisibleOnWidgetAndIcal;
  ...
  static Future<PcoCollection<PcoCalendarEventTime>> getFromEventInstance(String eventInstanceId, {String? id, PcoCalendarEventTimeQuery? query, bool includeEvent = false,}) async {
