...
class PcoCalendarFeed extends PcoResource {
  ...
  static Future<PcoCollection<PcoCalendarFeed>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoCalendarFeed>> getFromEvent(String eventId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
