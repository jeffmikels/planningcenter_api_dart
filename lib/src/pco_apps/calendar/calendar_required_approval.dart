/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:43:01.500999
...
class PcoCalendarRequiredApprovalQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCalendarRequiredApprovalOrder order, {bool reverse = false}) =>
  ...
  static String filterString(PcoCalendarRequiredApprovalFilter filter) => _filterMap[filter]!;
...
class PcoCalendarRequiredApproval extends PcoResource {
  ...
  static const String kDefaultPathTemplate = 'https://api.planningcenteronline.com/calendar/v2/resource_approval_groups/1/required_approvals';
  ...
  // Class Constructors
  PcoCalendarRequiredApproval.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCalendarRequiredApproval({String? id, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoCalendarRequiredApproval>> getFromResourceApprovalGroup(String resourceApprovalGroupId, {String? id, PcoCalendarRequiredApprovalQuery? query, bool includeResource = false,}) async {
    query ??= PcoCalendarRequiredApprovalQuery();
    
    if (includeResource) query.include.add('resource');
    var url = '/calendar/v2/resource_approval_groups/$resourceApprovalGroupId/required_approvals';
    if (id != null) url += '/$id';
    return PcoCollection.fromApiCall<PcoCalendarRequiredApproval>(url, query: query, apiVersion:kApiVersion);
  }
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarRequiredApproval>> getFromResource(String resourceId, {String? id, PcoCalendarRequiredApprovalQuery? query, bool includeResource = false,}) async {
    query ??= PcoCalendarRequiredApprovalQuery();
