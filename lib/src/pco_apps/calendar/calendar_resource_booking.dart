...
enum PcoCalendarResourceBookingFilter { approved, approvedPending, approvedPendingRejected, approvedRejected, future, pending, pendingRejected, rejected, resources, rooms }
...
class PcoCalendarResourceBookingQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCalendarResourceBookingOrder order, {bool reverse = false}) =>
  ...
  static final Map<PcoCalendarResourceBookingFilter, String> _filterMap = {
    ...
    PcoCalendarResourceBookingFilter.approvedPendingRejected: 'approved_pending_rejected',
  ...
  static String filterString(PcoCalendarResourceBookingFilter filter) => _filterMap[filter]!;
  ...
  PcoCalendarResourceBookingQuery({
    ...
    if (includeAll || includeEventResourceRequest) include.add('event_resource_request');
...
class PcoCalendarResourceBooking extends PcoResource {
  ...
  static Future<PcoCollection<PcoCalendarResourceBooking>> get( {String? id, PcoCalendarResourceBookingQuery? query, bool includeAll = false, bool includeEventInstance = false, bool includeEventResourceRequest = false, bool includeResource = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarResourceBooking>> getFromEventInstance(String eventInstanceId, {String? id, PcoCalendarResourceBookingQuery? query, bool includeAll = false, bool includeEventInstance = false, bool includeEventResourceRequest = false, bool includeResource = false,}) async {
    query ??= PcoCalendarResourceBookingQuery();
    if (includeAll) query.include.addAll(PcoCalendarResourceBooking.canInclude);
    if (includeEventInstance) query.include.add('event_instance');
    if (includeEventResourceRequest) query.include.add('event_resource_request');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarResourceBooking>> getFromEvent(String eventId, {String? id, PcoCalendarResourceBookingQuery? query, bool includeAll = false, bool includeEventInstance = false, bool includeEventResourceRequest = false, bool includeResource = false,}) async {
    query ??= PcoCalendarResourceBookingQuery();
    if (includeAll) query.include.addAll(PcoCalendarResourceBooking.canInclude);
    if (includeEventInstance) query.include.add('event_instance');
    if (includeEventResourceRequest) query.include.add('event_resource_request');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarResourceBooking>> getFromEventResourceRequest(String eventResourceRequestId, {String? id, PcoCalendarResourceBookingQuery? query, bool includeAll = false, bool includeEventInstance = false, bool includeEventResourceRequest = false, bool includeResource = false,}) async {
    query ??= PcoCalendarResourceBookingQuery();
    if (includeAll) query.include.addAll(PcoCalendarResourceBooking.canInclude);
    if (includeEventInstance) query.include.add('event_instance');
    if (includeEventResourceRequest) query.include.add('event_resource_request');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarResourceBooking>> getFromResource(String resourceId, {String? id, PcoCalendarResourceBookingQuery? query, bool includeAll = false, bool includeEventInstance = false, bool includeEventResourceRequest = false, bool includeResource = false,}) async {
    query ??= PcoCalendarResourceBookingQuery();
    if (includeAll) query.include.addAll(PcoCalendarResourceBooking.canInclude);
    if (includeEventInstance) query.include.add('event_instance');
    if (includeEventResourceRequest) query.include.add('event_resource_request');
  ...
  Future<PcoCollection<PcoCalendarEventInstance>> getEventInstance({PcoCalendarEventInstanceQuery? query}) async {
  ...
  Future<PcoCollection<PcoCalendarEventResourceRequest>> getEventResourceRequest({PcoCalendarEventResourceRequestQuery? query}) async {
