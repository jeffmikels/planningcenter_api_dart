...
class PcoCalendarResourceFolder extends PcoResource {
  ...
  /// - `resources`
  /// - `rooms`
  static Future<PcoCollection<PcoCalendarResourceFolder>> get( {String? id, PlanningCenterApiQuery? query, bool includeResources = false,}) async {
  ...
  static Future<PcoCollection<PcoCalendarResourceFolder>> getFromResource(String resourceId, {String? id, PlanningCenterApiQuery? query, bool includeResources = false,}) async {
    query ??= PlanningCenterApiQuery();
