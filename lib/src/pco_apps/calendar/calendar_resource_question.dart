/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:43:01.503870
...
class PcoCalendarResourceQuestionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCalendarResourceQuestionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCalendarResourceQuestionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCalendarResourceQuestionFilter filter) => _filterMap[filter]!;
...
class PcoCalendarResourceQuestion extends PcoResource {
  ...
  // Class Constructors
  PcoCalendarResourceQuestion.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCalendarResourceQuestion({String? id, DateTime? createdAt, String? kind, DateTime? updatedAt, String? choices, String? description, bool? isMultipleSelect, bool? isOptional, int? position, String? question, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isMultipleSelect != null) obj._attributes['multiple_select'] = isMultipleSelect;
  ...
  static Future<PcoCollection<PcoCalendarResourceQuestion>> get( {String? id, PcoCalendarResourceQuestionQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCalendarResourceQuestion>> getFromResource(String resourceId, {String? id, PcoCalendarResourceQuestionQuery? query, }) async {
    query ??= PcoCalendarResourceQuestionQuery();
