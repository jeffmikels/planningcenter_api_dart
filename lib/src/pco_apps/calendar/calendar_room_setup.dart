/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.811024
...
class PcoCalendarRoomSetup extends PcoResource {
  ...
  List<T> includedContainingResource<T extends PcoResource>() => relationships['containing_resource']?.cast<T>() ?? [];
  List<T> includedResourceSuggestions<T extends PcoResource>() => relationships['resource_suggestions']?.cast<T>() ?? [];
