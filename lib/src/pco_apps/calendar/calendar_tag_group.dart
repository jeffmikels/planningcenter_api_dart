...
class PcoCalendarTagGroup extends PcoResource {
  ...
  /// - `required`
  static Future<PcoCollection<PcoCalendarTagGroup>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeEvents = false, bool includeTags = false,}) async {
  ...
  static Future<PcoCollection<PcoCalendarTagGroup>> getFromTag(String tagId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeEvents = false, bool includeTags = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoCalendarTagGroup.canInclude);
    if (includeEvents) query.include.add('events');
    if (includeTags) query.include.add('tags');
