/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:22.771092
...
class PcoCheckInsAttendanceTypeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsAttendanceTypeOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsAttendanceTypeFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsAttendanceTypeFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsAttendanceType extends PcoResource {
  ...
  // Class Constructors
  PcoCheckInsAttendanceType.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCheckInsAttendanceType({String? id, String? name, String? color, DateTime? createdAt, DateTime? updatedAt, int? limit, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoCheckInsAttendanceType>> getFromEvent(String eventId, {String? id, PcoCheckInsAttendanceTypeQuery? query, bool includeEvent = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsAttendanceType>> getFromHeadcount(String headcountId, {PcoCheckInsAttendanceTypeQuery? query, bool includeEvent = false,}) async {
    query ??= PcoCheckInsAttendanceTypeQuery();
