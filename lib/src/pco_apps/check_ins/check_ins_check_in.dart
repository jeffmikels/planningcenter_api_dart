...
class PcoCheckInsCheckIn extends PcoResource {
  ...
  List<T> includedCheckInTimes<T extends PcoResource>() => relationships['check_in_times']?.cast<T>() ?? [];
  List<T> includedCheckedInAt<T extends PcoResource>() => relationships['checked_in_at']?.cast<T>() ?? [];
  List<T> includedCheckedInBy<T extends PcoResource>() => relationships['checked_in_by']?.cast<T>() ?? [];
  List<T> includedCheckedOutBy<T extends PcoResource>() => relationships['checked_out_by']?.cast<T>() ?? [];
  List<T> includedEvent<T extends PcoResource>() => relationships['event']?.cast<T>() ?? [];
  List<T> includedEventPeriod<T extends PcoResource>() => relationships['event_period']?.cast<T>() ?? [];
  List<T> includedEventTimes<T extends PcoResource>() => relationships['event_times']?.cast<T>() ?? [];
  List<T> includedLocations<T extends PcoResource>() => relationships['locations']?.cast<T>() ?? [];
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> get( {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromCheckInAndCheckInGroup(String checkInId,String checkInGroupId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromEvent(String eventId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromCheckInAndEventPeriod(String checkInId,String eventPeriodId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromEventTime(String eventTimeId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromCheckInAndLocation(String checkInId,String locationId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromCheckInAndEventPeriodAndLocationEventPeriod(String checkInId,String eventPeriodId,String locationEventPeriodId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromEventTimeAndLocationEventTime(String eventTimeId,String locationEventTimeId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFromPeople(String peopleId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  static Future<PcoCollection<PcoCheckInsCheckIn>> getFirstCheckInFromEventAndPersonEvent(String eventId,String personEventId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  static Future<PcoCollection<PcoCheckInsCheckIn>> getLastCheckInFromEventAndPersonEvent(String eventId,String personEventId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  /// - `regular`
  /// - `volunteer`
  static Future<PcoCollection<PcoCheckInsCheckIn>> getCheckedInAtCheckInsFromStation(String stationId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsCheckIn.canInclude;
  ...
  Future<PcoCollection<PcoCheckInsCheckInGroup>> getCheckInGroup({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoCheckInsStation>> getCheckedInAt({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoCheckInsPerson>> getCheckedInBy({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoCheckInsPerson>> getCheckedOutBy({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoCheckInsPerson.canInclude;
