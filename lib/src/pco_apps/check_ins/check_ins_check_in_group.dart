/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T18:03:47.573843
...
class PcoCheckInsCheckInGroupQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsCheckInGroupOrder order,
          {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsCheckInGroupFilter, String> _filterMap = {};
  static String filterString(PcoCheckInsCheckInGroupFilter filter) =>
      _filterMap[filter]!;
...
class PcoCheckInsCheckInGroup extends PcoResource {
  ...
  factory PcoCheckInsCheckInGroup(
      {String? id,
      int? nameLabelsCount,
      int? securityLabelsCount,
      int? checkInsCount,
      String? printStatus,
      DateTime? createdAt,
      DateTime? updatedAt,
    ...
    obj._id = id;
    if (nameLabelsCount != null)
      obj._attributes['name_labels_count'] = nameLabelsCount;
    if (securityLabelsCount != null)
      obj._attributes['security_labels_count'] = securityLabelsCount;
    if (checkInsCount != null)
      obj._attributes['check_ins_count'] = checkInsCount;
