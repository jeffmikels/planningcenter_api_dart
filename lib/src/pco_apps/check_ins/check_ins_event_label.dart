/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:22.780705
...
class PcoCheckInsEventLabelQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsEventLabelOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsEventLabelFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsEventLabelFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsEventLabel extends PcoResource {
  ...
  // Class Constructors
  PcoCheckInsEventLabel.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCheckInsEventLabel({String? id, int? quantity, bool? isForRegular, bool? isForGuest, bool? isForVolunteer, DateTime? createdAt, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoCheckInsEventLabel>> getFromEvent(String eventId, {String? id, PcoCheckInsEventLabelQuery? query, bool includeAll = false, bool includeEvent = false, bool includeLabel = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventLabel>> getFromLabel(String labelId, {String? id, PcoCheckInsEventLabelQuery? query, bool includeAll = false, bool includeEvent = false, bool includeLabel = false,}) async {
    query ??= PcoCheckInsEventLabelQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventLabel.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeLabel) query.include.add('label');
