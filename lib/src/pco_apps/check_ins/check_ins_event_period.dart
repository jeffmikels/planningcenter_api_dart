/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.410352
...
class PcoCheckInsEventPeriodQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsEventPeriodOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsEventPeriodFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsEventPeriodFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsEventPeriod extends PcoResource {
  ...
  static Future<PcoCollection<PcoCheckInsEventPeriod>> getFromCheckIn(String checkInId, {PcoCheckInsEventPeriodQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventPeriod>> getFromCheckInAndCheckInGroup(String checkInId,String checkInGroupId, {PcoCheckInsEventPeriodQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false,}) async {
    query ??= PcoCheckInsEventPeriodQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventPeriod.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventPeriod>> getFromEvent(String eventId, {String? id, PcoCheckInsEventPeriodQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false,}) async {
    query ??= PcoCheckInsEventPeriodQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventPeriod.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventPeriod>> getFromEventTime(String eventTimeId, {PcoCheckInsEventPeriodQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false,}) async {
    query ??= PcoCheckInsEventPeriodQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventPeriod.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventPeriod>> getFromCheckInAndEventPeriodAndLocationEventPeriod(String checkInId,String eventPeriodId,String locationEventPeriodId, {PcoCheckInsEventPeriodQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventTimes = false,}) async {
    query ??= PcoCheckInsEventPeriodQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventPeriod.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventTimes) query.include.add('event_times');
