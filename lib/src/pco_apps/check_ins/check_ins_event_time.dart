/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.411240
...
class PcoCheckInsEventTimeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsEventTimeOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsEventTimeFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsEventTimeFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsEventTime extends PcoResource {
  ...
  static Future<PcoCollection<PcoCheckInsEventTime>> get( {String? id, PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventTime>> getFromCheckIn(String checkInId, {String? id, PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
    query ??= PcoCheckInsEventTimeQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventTime.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventPeriod) query.include.add('event_period');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventTime>> getCurrentEventTimesFromEvent(String eventId, {PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
    query ??= PcoCheckInsEventTimeQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventTime.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventPeriod) query.include.add('event_period');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventTime>> getFromCheckInAndEventPeriod(String checkInId,String eventPeriodId, {String? id, PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
    query ??= PcoCheckInsEventTimeQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventTime.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventPeriod) query.include.add('event_period');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventTime>> getFromHeadcount(String headcountId, {PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
    query ??= PcoCheckInsEventTimeQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventTime.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventPeriod) query.include.add('event_period');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsEventTime>> getFromEventTimeAndLocationEventTime(String eventTimeId,String locationEventTimeId, {PcoCheckInsEventTimeQuery? query, bool includeAll = false, bool includeEvent = false, bool includeEventPeriod = false, bool includeHeadcounts = false,}) async {
    query ??= PcoCheckInsEventTimeQuery();
    if (includeAll) query.include.addAll(PcoCheckInsEventTime.canInclude);
    if (includeEvent) query.include.add('event');
    if (includeEventPeriod) query.include.add('event_period');
  ...
  /// Available Query Filters:
  /// - `for_current_station`
  Future<PcoCollection<PcoCheckInsLocation>> getAvailableLocations({PcoCheckInsLocationQuery? query}) async {
  ...
  Future<PcoCollection<PcoCheckInsHeadcount>> getHeadcounts({PcoCheckInsHeadcountQuery? query}) async {
