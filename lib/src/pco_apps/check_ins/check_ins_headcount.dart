/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.662375
...
class PcoCheckInsHeadcount extends PcoResource {
  ...
  List<T> includedAttendanceType<T extends PcoResource>() => relationships['attendance_type']?.cast<T>() ?? [];
  List<T> includedEventTime<T extends PcoResource>() => relationships['event_time']?.cast<T>() ?? [];
