/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T18:03:47.577521
...
class PcoCheckInsHeadcountQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsHeadcountOrder order,
          {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsHeadcountFilter, String> _filterMap = {};
  static String filterString(PcoCheckInsHeadcountFilter filter) =>
      _filterMap[filter]!;
