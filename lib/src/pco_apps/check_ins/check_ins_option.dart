...
class PcoCheckInsOptionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsOptionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsOptionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsOptionFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsOption extends PcoResource {
  ...
  // Class Constructors
  PcoCheckInsOption.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCheckInsOption({String? id, String? body, int? quantity, DateTime? createdAt, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoCheckInsOption>> getFromCheckIn(String checkInId, {String? id, PcoCheckInsOptionQuery? query, bool includeLabel = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsOption>> getFromCheckInAndLocation(String checkInId,String locationId, {String? id, PcoCheckInsOptionQuery? query, bool includeLabel = false,}) async {
    query ??= PcoCheckInsOptionQuery();
