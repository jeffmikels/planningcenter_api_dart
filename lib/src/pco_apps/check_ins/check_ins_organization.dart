/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.656017
...
/// - Manually create an object using the `PcoCheckInsOrganization.manual()` constructor.
...
class PcoCheckInsOrganization extends PcoResource {
  ...
  // Class Constructors
  PcoCheckInsOrganization.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoCheckInsOrganization({String? id, String? dateFormatPattern, String? timeZoneOlson, String? name, int? dailyCheckIns, String? timeZone, String? avatarUrl, DateTime? createdAt, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    var obj = PcoCheckInsOrganization.empty();
    obj._id = id;
    if (dateFormatPattern != null) obj._attributes['date_format_pattern'] = dateFormatPattern;
    if (timeZoneOlson != null) obj._attributes['time_zone_olson'] = timeZoneOlson;
    if (name != null) obj._attributes['name'] = name;
    if (dailyCheckIns != null) obj._attributes['daily_check_ins'] = dailyCheckIns;
  ...
  static Future<PcoCollection<PcoCheckInsOrganization>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  /// - `for_headcounts`
  /// - `not_archived`
  Future<PcoCollection<PcoCheckInsEvent>> getEvents({PlanningCenterApiQuery? query, bool includeAll = false, bool includeAttendanceTypes = false, bool includeEventPeriods = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoCheckInsOrganization.canInclude);
  ...
  Future<PcoCollection<PcoCheckInsLabel>> getLabels({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoCheckInsPass>> getPasses({PlanningCenterApiQuery? query, bool includePerson = false,}) async {
    query ??= PlanningCenterApiQuery();
    
    if (includePerson) query.include.add('person');
    var url = '$apiEndpoint/passes';
    return PcoCollection.fromApiCall<PcoCheckInsPass>(url, query: query, apiVersion: apiVersion);
  }
  ...
  Future<PcoCollection<PcoCheckInsPerson>> getPeople({PlanningCenterApiQuery? query, bool includeOrganization = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoCheckInsStation>> getStations({PlanningCenterApiQuery? query, bool includeAll = false, bool includeEvent = false, bool includeLocation = false, bool includePrintStation = false, bool includeTheme = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoCheckInsOrganization.canInclude);
    if (includeEvent) query.include.add('event');
  ...
  Future<PcoCollection<PcoCheckInsTheme>> getThemes({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
