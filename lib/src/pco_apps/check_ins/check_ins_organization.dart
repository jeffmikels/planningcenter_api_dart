...
class PcoCheckInsOrganizationQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsOrganizationOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsOrganizationFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsOrganizationFilter filter) => _filterMap[filter]!;
...
class PcoCheckInsOrganization extends PcoResource {
  ...
  static Future<PcoCollection<PcoCheckInsOrganization>> getFromPerson(String personId, {String? id, PcoCheckInsOrganizationQuery? query, }) async {
  ...
  /// - `for_headcounts`
  /// - `not_archived`
  Future<PcoCollection<PcoCheckInsEvent>> getEvents({PcoCheckInsEventQuery? query}) async {
  ...
  Future<PcoCollection<PcoCheckInsLabel>> getLabels({PcoCheckInsLabelQuery? query}) async {
  ...
  Future<PcoCollection<PcoCheckInsPerson>> getPeople({PcoCheckInsPersonQuery? query}) async {
  ...
  Future<PcoCollection<PcoCheckInsStation>> getStations({PcoCheckInsStationQuery? query}) async {
  ...
  Future<PcoCollection<PcoCheckInsTheme>> getThemes({PcoCheckInsThemeQuery? query}) async {
