/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.665874
...
class PcoCheckInsOrganization extends PcoResource {
  ...
  static Future<PcoCollection<PcoCheckInsOrganization>> getFromPeople(String peopleId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  Future<PcoCollection<PcoCheckInsPerson>> getPeople({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
