...
enum PcoCheckInsPersonOrder { checkInCount, firstName, lastCheckedInAt, lastName }
...
class PcoCheckInsPersonQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoCheckInsPersonOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoCheckInsPersonFilter, String> _filterMap = {
    
  };
  static String filterString(PcoCheckInsPersonFilter filter) => _filterMap[filter]!;
  ...
  PcoCheckInsPersonQuery({
    ...
    if (whereHeadcounter != null) where.add(PlanningCenterApiWhere.parse('headcounter', whereHeadcounter));
...
class PcoCheckInsPerson extends PcoResource {
  ...
  static Future<PcoCollection<PcoCheckInsPerson>> get( {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsPerson>> getCheckedInByFromCheckIn(String checkInId, {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
    query ??= PcoCheckInsPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsPerson>> getCheckedOutByFromCheckIn(String checkInId, {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
    query ??= PcoCheckInsPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsPerson>> getFromCheckIn(String checkInId, {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
    query ??= PcoCheckInsPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsPerson>> getFromPass(String passId, {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
    query ??= PcoCheckInsPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoCheckInsPerson>> getFromEventAndPersonEvent(String eventId,String personEventId, {String? id, PcoCheckInsPersonQuery? query, bool includeOrganization = false,}) async {
    query ??= PcoCheckInsPersonQuery();
  ...
  Future<PcoCollection<PcoCheckInsOrganization>> getOrganization({PcoCheckInsOrganizationQuery? query}) async {
