/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.812669
...
/// - Manually create an object using the `PcoGivingBatchGroup.manual()` constructor.
...
class PcoGivingBatchGroup extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingBatchGroup>> get( {String? id, PlanningCenterApiQuery? query, bool includeOwner = false,}) async {
  ...
  static Future<PcoCollection<PcoGivingBatchGroup>> getFromBatch(String batchId, {String? id, PlanningCenterApiQuery? query, bool includeOwner = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoGivingBatchGroup>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includeOwner = false,}) async {
    query ??= PlanningCenterApiQuery();
