/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.813436
...
/// - Manually create an object using the `PcoGivingDesignation.manual()` constructor.
...
class PcoGivingDesignation extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingDesignation>> getFromDonationAndRefundAndDesignationRefund(String donationId,String designationRefundId, {PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoGivingDesignation>> getFromDonation(String donationId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
