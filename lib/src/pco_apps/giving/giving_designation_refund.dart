...
class PcoGivingDesignationRefundQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGivingDesignationRefundOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGivingDesignationRefundFilter, String> _filterMap = {
    
  };
  static String filterString(PcoGivingDesignationRefundFilter filter) => _filterMap[filter]!;
...
class PcoGivingDesignationRefund extends PcoResource {
  ...
  PcoGivingDesignation? get includedDesignation => _firstOrNull<PcoGivingDesignation>(relationships['designation']);

  // Class Constructors
  PcoGivingDesignationRefund.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGivingDesignationRefund({String? id, int? amountCents, String? amountCurrency, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoGivingDesignationRefund>> getFromDonationAndRefund(String donationId,String refundId, {String? id, PcoGivingDesignationRefundQuery? query, bool includeDesignation = false,}) async {
  ...
  Future<PcoCollection<PcoGivingDesignation>> getDesignation({PcoGivingDesignationQuery? query}) async {
