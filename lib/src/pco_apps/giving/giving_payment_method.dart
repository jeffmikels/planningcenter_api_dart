...
class PcoGivingPaymentMethodQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGivingPaymentMethodOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGivingPaymentMethodFilter, String> _filterMap = {
    
  };
  static String filterString(PcoGivingPaymentMethodFilter filter) => _filterMap[filter]!;
...
class PcoGivingPaymentMethod extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingPaymentMethod>> getFromPerson(String personId, {String? id, PcoGivingPaymentMethodQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGivingPaymentMethod>> getFromRecurringDonation(String recurringDonationId, {String? id, PcoGivingPaymentMethodQuery? query, }) async {
    query ??= PcoGivingPaymentMethodQuery();
