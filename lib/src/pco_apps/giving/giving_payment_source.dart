...
class PcoGivingPaymentSourceQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGivingPaymentSourceOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGivingPaymentSourceFilter, String> _filterMap = {
    
  };
  static String filterString(PcoGivingPaymentSourceFilter filter) => _filterMap[filter]!;
...
class PcoGivingPaymentSource extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingPaymentSource>> get( {String? id, PcoGivingPaymentSourceQuery? query, }) async {
