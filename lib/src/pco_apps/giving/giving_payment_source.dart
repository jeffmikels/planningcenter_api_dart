/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.816535
...
/// - Manually create an object using the `PcoGivingPaymentSource.manual()` constructor.
...
class PcoGivingPaymentSource extends PcoResource {
  ...
  // Class Constructors
  PcoGivingPaymentSource.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGivingPaymentSource({String? id, DateTime? createdAt, DateTime? updatedAt, String? name, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoGivingPaymentSource>> get( {String? id, PlanningCenterApiQuery? query, }) async {
