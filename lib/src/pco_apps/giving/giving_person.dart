...
class PcoGivingPerson extends PcoResource {
  ...
  // Class Constructors
  PcoGivingPerson.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGivingPerson({String? id, String? permissions, List? emailAddresses, List? addresses, List? phoneNumbers, String? firstName, String? lastName, int? donorNumber, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  /// 
  static Future<PcoCollection<PcoGivingPerson>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoGivingPerson>> getOwnerFromBatchGroup(String batchGroupId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoGivingPerson>> getOwnerFromBatch(String batchId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoGivingPerson>> getJointGiverFromPledge(String pledgeId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoGivingBatchGroup>> getBatchGroups({PlanningCenterApiQuery? query, bool includeOwner = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `committed`
  /// - `in_progress`
  Future<PcoCollection<PcoGivingBatch>> getBatches({PlanningCenterApiQuery? query, bool includeAll = false, bool includeBatchGroup = false, bool includeOwner = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoGivingPaymentMethod>> getPaymentMethods({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoGivingPledge>> getPledges({PlanningCenterApiQuery? query, bool includeAll = false, bool includeJointGiver = false, bool includePledgeCampaign = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoGivingPerson.canInclude);
  ...
  Future<PcoCollection<PcoGivingCampus>> getPrimaryCampus({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
