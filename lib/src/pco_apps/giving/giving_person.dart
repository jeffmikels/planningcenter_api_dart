...
class PcoGivingPersonQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGivingPersonOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGivingPersonFilter, String> _filterMap = {
    PcoGivingPersonFilter.hasDonated: 'has_donated',
  };
  static String filterString(PcoGivingPersonFilter filter) => _filterMap[filter]!;
...
class PcoGivingPerson extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingPerson>> get( {String? id, PcoGivingPersonQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGivingPerson>> getOwnerFromBatchGroup(String batchGroupId, {PcoGivingPersonQuery? query, }) async {
    query ??= PcoGivingPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGivingPerson>> getOwnerFromBatch(String batchId, {PcoGivingPersonQuery? query, }) async {
    query ??= PcoGivingPersonQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGivingPerson>> getJointGiverFromPledge(String pledgeId, {PcoGivingPersonQuery? query, }) async {
    query ??= PcoGivingPersonQuery();
  ...
  Future<PcoCollection<PcoGivingBatchGroup>> getBatchGroups({PcoGivingBatchGroupQuery? query}) async {
  ...
  Future<PcoCollection<PcoGivingPaymentMethod>> getPaymentMethods({PcoGivingPaymentMethodQuery? query}) async {
  ...
  Future<PcoCollection<PcoGivingCampus>> getPrimaryCampus({PcoGivingCampusQuery? query}) async {
  ...
  Future<PcoCollection<PcoGivingRecurringDonation>> getRecurringDonations({PcoGivingRecurringDonationQuery? query}) async {
