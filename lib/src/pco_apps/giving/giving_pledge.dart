/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.831245
...
class PcoGivingPledge extends PcoResource {
  ...
  List<T> includedJointGiver<T extends PcoResource>() => relationships['joint_giver']?.cast<T>() ?? [];
  List<T> includedPledgeCampaign<T extends PcoResource>() => relationships['pledge_campaign']?.cast<T>() ?? [];
