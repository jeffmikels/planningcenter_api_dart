/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.823867
...
/// - Manually create an object using the `PcoGivingRecurringDonation.manual()` constructor.
...
class PcoGivingRecurringDonation extends PcoResource {
  ...
  static Future<PcoCollection<PcoGivingRecurringDonation>> get( {String? id, PlanningCenterApiQuery? query, bool includeDesignations = false,}) async {
  ...
  static Future<PcoCollection<PcoGivingRecurringDonation>> getFromPersonAndPaymentMethod(String personId,String paymentMethodId, {String? id, PlanningCenterApiQuery? query, bool includeDesignations = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoGivingRecurringDonation>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includeDesignations = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoGivingPaymentMethod>> getPaymentMethod({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoGivingRecurringDonationDesignation>> getDesignations({PlanningCenterApiQuery? query, bool includeFund = false,}) async {
    query ??= PlanningCenterApiQuery();
