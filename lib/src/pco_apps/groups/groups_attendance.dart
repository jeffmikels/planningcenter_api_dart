/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:43:17.386191
...
class PcoGroupsAttendanceQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsAttendanceOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGroupsAttendanceFilter, String> _filterMap = {
    PcoGroupsAttendanceFilter.attended: 'attended',
  };
  static String filterString(PcoGroupsAttendanceFilter filter) => _filterMap[filter]!;
  ...
  PcoGroupsAttendanceQuery({
    ...
    if (whereRole != null) where.add(PlanningCenterApiWhere.parse('role', whereRole));
...
class PcoGroupsAttendance extends PcoResource {
  ...
  PcoGroupsPerson? get includedPerson => _firstOrNull<PcoGroupsPerson>(relationships['person']);

  // Class Constructors
  PcoGroupsAttendance.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGroupsAttendance({String? id, bool? isAttended, String? role, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoGroupsAttendance>> getFromEvent(String eventId, {String? id, PcoGroupsAttendanceQuery? query, bool includePerson = false,}) async {
  ...
  Future<PcoCollection<PcoGroupsPerson>> getPerson({PcoGroupsPersonQuery? query}) async {
