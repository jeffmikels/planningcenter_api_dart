...
class PcoGroupsEventQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsEventOrder order, {bool reverse = false}) =>
  ...
  static String filterString(PcoGroupsEventFilter filter) => _filterMap[filter]!;
...
class PcoGroupsEvent extends PcoResource {
  ...
  static const String kDefaultPathTemplate = 'https://api.planningcenteronline.com/groups/v2/events';
  ...
  bool get isAttendanceRequestsEnabled => _attributes[kAttendanceRequestsEnabled] == true;
  bool get isAutomatedReminderEnabled => _attributes[kAutomatedReminderEnabled] == true;
  ...
  DateTime get remindersSentAt => DateTime.parse(_attributes[kRemindersSentAt] ?? '');
  ...
  PcoGroupsGroup? get includedGroup => _firstOrNull<PcoGroupsGroup>(relationships['group']);
  PcoGroupsLocation? get includedLocation => _firstOrNull<PcoGroupsLocation>(relationships['location']);

  // Class Constructors
  PcoGroupsEvent.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGroupsEvent({String? id, bool? isAttendanceRequestsEnabled, bool? isAutomatedReminderEnabled, bool? isCanceled, DateTime? canceledAt, String? description, DateTime? endsAt, String? locationTypePreference, bool? isMultiDay, String? name, bool? isRemindersSent, DateTime? remindersSentAt, bool? isRepeating, DateTime? startsAt, String? virtualLocationUrl, int? visitorsCount, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isAutomatedReminderEnabled != null) obj._attributes['automated_reminder_enabled'] = isAutomatedReminderEnabled;
    if (isCanceled != null) obj._attributes['canceled'] = isCanceled;
    if (canceledAt != null) obj._attributes['canceled_at'] = canceledAt.toIso8601String();
    ...
    if (isRemindersSent != null) obj._attributes['reminders_sent'] = isRemindersSent;
    if (remindersSentAt != null) obj._attributes['reminders_sent_at'] = remindersSentAt.toIso8601String();
  ...
  static Future<PcoCollection<PcoGroupsEvent>> get( {String? id, PcoGroupsEventQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroup(String groupId, {String? id, PcoGroupsEventQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsEventQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroupType(String groupTypeId, {String? id, PcoGroupsEventQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsEventQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsEvent>> getFromPerson(String personId, {String? id, PcoGroupsEventQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsEventQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// Available Query Filters:
  /// - `attended`
  Future<PcoCollection<PcoGroupsAttendance>> getAttendances({PcoGroupsAttendanceQuery? query}) async {
  ...
  Future<PcoCollection<PcoGroupsGroup>> getGroup({PcoGroupsGroupQuery? query}) async {
