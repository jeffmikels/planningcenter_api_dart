...
class PcoGroupsEvent extends PcoResource {
  ...
  List<T> includedGroup<T extends PcoResource>() => relationships['group']?.cast<T>() ?? [];
  ...
  /// - `not_canceled`
  /// - `upcoming`
  static Future<PcoCollection<PcoGroupsEvent>> get( {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  /// - `canceled`
  /// - `not_canceled`
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroup(String groupId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoGroupsEvent.canInclude;
  ...
  /// - `not_canceled`
  /// - `upcoming`
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroupType(String groupTypeId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoGroupsEvent.canInclude;
  ...
  /// - `canceled`
  /// - `not_canceled`
  static Future<PcoCollection<PcoGroupsEvent>> getFromPeople(String peopleId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoGroupsEvent.canInclude;
