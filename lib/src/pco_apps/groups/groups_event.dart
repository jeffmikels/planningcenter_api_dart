...
class PcoGroupsEvent extends PcoResource {
  ...
  /// - `not_canceled`
  /// - `upcoming`
  static Future<PcoCollection<PcoGroupsEvent>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
  ...
  /// - `canceled`
  /// - `not_canceled`
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroup(String groupId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// - `not_canceled`
  /// - `upcoming`
  static Future<PcoCollection<PcoGroupsEvent>> getFromGroupType(String groupTypeId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// - `canceled`
  /// - `not_canceled`
  static Future<PcoCollection<PcoGroupsEvent>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeGroup = false, bool includeLocation = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoGroupsEvent.canInclude);
    if (includeGroup) query.include.add('group');
    if (includeLocation) query.include.add('location');
  ...
  /// Available Query Filters:
  /// - `attended`
  Future<PcoCollection<PcoGroupsAttendance>> getAttendances({PlanningCenterApiQuery? query, bool includePerson = false,}) async {
    query ??= PlanningCenterApiQuery();
