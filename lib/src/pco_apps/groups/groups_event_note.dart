/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T18:03:47.768872
...
class PcoGroupsEventNoteQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsEventNoteOrder order,
          {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGroupsEventNoteFilter, String> _filterMap = {};
  static String filterString(PcoGroupsEventNoteFilter filter) =>
      _filterMap[filter]!;
...
class PcoGroupsEventNote extends PcoResource {
  ...
  PcoGroupsOwner? get includedOwner =>
      _firstOrNull<PcoGroupsOwner>(relationships['owner']);

  // Class Constructors
  PcoGroupsEventNote.fromJson(Map<String, dynamic> data,
  ...
  Future<PcoCollection<PcoGroupsOwner>> getOwner(
      {PcoGroupsOwnerQuery? query}) async {
