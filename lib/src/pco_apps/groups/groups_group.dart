...
class PcoGroupsGroupQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsGroupOrder order, {bool reverse = false}) =>
  ...
  PcoGroupsGroupQuery({
    ...
    if (whereArchiveStatus != null) where.add(PlanningCenterApiWhere.parse('archive_status', whereArchiveStatus));
...
class PcoGroupsGroup extends PcoResource {
  ...
  String get locationTypePreference => _attributes[kLocationTypePreference] ?? '';
  int get membershipsCount => _attributes[kMembershipsCount] ?? 0;
  String get name => _attributes[kName] ?? '';
  String get publicChurchCenterWebUrl => _attributes[kPublicChurchCenterWebUrl] ?? '';
  ...
  PcoGroupsGroupType? get includedGroupType => _firstOrNull<PcoGroupsGroupType>(relationships['group_type']);
  PcoGroupsLocation? get includedLocation => _firstOrNull<PcoGroupsLocation>(relationships['location']);

  // Class Constructors
  PcoGroupsGroup.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoGroupsGroup({String? id, String? archiveStatus, DateTime? archivedAt, String? contactEmail, DateTime? createdAt, String? description, bool? isEnrollmentOpen, String? enrollmentStrategy, String? eventsVisibility, String? headerImage, String? locationTypePreference, int? membershipsCount, String? name, String? publicChurchCenterWebUrl, String? schedule, String? virtualLocationUrl, String? widgetStatus, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    var obj = PcoGroupsGroup.empty();
    obj._id = id;
    if (archiveStatus != null) obj._attributes['archive_status'] = archiveStatus;
    ...
    if (isEnrollmentOpen != null) obj._attributes['enrollment_open'] = isEnrollmentOpen;
    if (enrollmentStrategy != null) obj._attributes['enrollment_strategy'] = enrollmentStrategy;
    if (eventsVisibility != null) obj._attributes['events_visibility'] = eventsVisibility;
    if (headerImage != null) obj._attributes['header_image'] = headerImage;
    if (locationTypePreference != null) obj._attributes['location_type_preference'] = locationTypePreference;
    if (membershipsCount != null) obj._attributes['memberships_count'] = membershipsCount;
    if (name != null) obj._attributes['name'] = name;
    if (publicChurchCenterWebUrl != null) obj._attributes['public_church_center_web_url'] = publicChurchCenterWebUrl;
  ...
  static Future<PcoCollection<PcoGroupsGroup>> get( {String? id, PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroup>> getFromEvent(String eventId, {PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsGroupQuery();
    if (includeAll) query.include.addAll(PcoGroupsGroup.canInclude);
    if (includeGroupType) query.include.add('group_type');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroup>> getFromGroupType(String groupTypeId, {String? id, PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsGroupQuery();
    if (includeAll) query.include.addAll(PcoGroupsGroup.canInclude);
    if (includeGroupType) query.include.add('group_type');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroup>> getFromGroupAndMembership(String groupId,String membershipId, {PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsGroupQuery();
    if (includeAll) query.include.addAll(PcoGroupsGroup.canInclude);
    if (includeGroupType) query.include.add('group_type');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroup>> getFromPerson(String personId, {String? id, PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsGroupQuery();
    if (includeAll) query.include.addAll(PcoGroupsGroup.canInclude);
    if (includeGroupType) query.include.add('group_type');
    if (includeLocation) query.include.add('location');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroup>> getFromTag(String tagId, {String? id, PcoGroupsGroupQuery? query, bool includeAll = false, bool includeGroupType = false, bool includeLocation = false,}) async {
    query ??= PcoGroupsGroupQuery();
    if (includeAll) query.include.addAll(PcoGroupsGroup.canInclude);
    if (includeGroupType) query.include.add('group_type');
    if (includeLocation) query.include.add('location');
  ...
  Future<PcoCollection<PcoGroupsGroupType>> getGroupType({PcoGroupsGroupTypeQuery? query}) async {
  ...
  Future<PcoCollection<PcoGroupsLocation>> getLocation({PcoGroupsLocationQuery? query}) async {
  ...
  Future<PcoCollection<PcoGroupsMembership>> getMemberships({PcoGroupsMembershipQuery? query}) async {
  ...
  /// 
  Future<PcoCollection<PcoGroupsResource>> getResources({PcoGroupsResourceQuery? query}) async {
  ...
  Future<PcoCollection<PcoGroupsTag>> getTags({PcoGroupsTagQuery? query}) async {
