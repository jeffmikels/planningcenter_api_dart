/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:43:17.389076
...
class PcoGroupsGroupTypeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsGroupTypeOrder order, {bool reverse = false}) =>
  ...
  static final Map<PcoGroupsGroupTypeFilter, String> _filterMap = {
    ...
    PcoGroupsGroupTypeFilter.notChurchCenterVisible: 'not_church_center_visible',
  };
  static String filterString(PcoGroupsGroupTypeFilter filter) => _filterMap[filter]!;
...
class PcoGroupsGroupType extends PcoResource {
  ...
  static Future<PcoCollection<PcoGroupsGroupType>> get( {String? id, PcoGroupsGroupTypeQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsGroupType>> getFromGroup(String groupId, {String? id, PcoGroupsGroupTypeQuery? query, }) async {
    query ??= PcoGroupsGroupTypeQuery();
