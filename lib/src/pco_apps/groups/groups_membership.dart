/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.586246
...
class PcoGroupsMembershipQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoGroupsMembershipOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoGroupsMembershipFilter, String> _filterMap = {
    
  };
  static String filterString(PcoGroupsMembershipFilter filter) => _filterMap[filter]!;
...
class PcoGroupsMembership extends PcoResource {
  ...
  static Future<PcoCollection<PcoGroupsMembership>> getFromGroup(String groupId, {String? id, PcoGroupsMembershipQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoGroupsMembership>> getFromPerson(String personId, {String? id, PcoGroupsMembershipQuery? query, }) async {
    query ??= PcoGroupsMembershipQuery();
