...
class PcoPeopleAddress extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleAddress>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleAddress>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
