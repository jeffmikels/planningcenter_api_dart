...
class PcoPeopleAppQuery extends PlanningCenterApiQuery {
  ...
  PcoPeopleAppQuery({
    ...
    if (whereUrl != null) where.add(PlanningCenterApiWhere.parse('url', whereUrl));
...
class PcoPeopleApp extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleApp.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleApp({String? id, String? name, String? url, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleApp>> get( {String? id, PcoPeopleAppQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleApp>> getFromMessageGroup(String messageGroupId, {String? id, PcoPeopleAppQuery? query, }) async {
    query ??= PcoPeopleAppQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleApp>> getFromPersonAndPersonApp(String personId,String personAppId, {String? id, PcoPeopleAppQuery? query, }) async {
    query ??= PcoPeopleAppQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleApp>> getFromPerson(String personId, {String? id, PcoPeopleAppQuery? query, }) async {
    query ??= PcoPeopleAppQuery();
