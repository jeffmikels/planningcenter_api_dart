...
class PcoPeopleApp extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleApp>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleApp>> getFromMessageGroup(String messageGroupId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoPeopleApp>> getFromPersonAndPersonApp(String personId,String personAppId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoPeopleApp>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
