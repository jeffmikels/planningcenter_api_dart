/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:51.398303
...
class PcoPeopleCampusQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleCampusOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleCampusFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleCampusFilter filter) => _filterMap[filter]!;
...
class PcoPeopleCampus extends PcoResource {
  ...
  bool get isGeolocationSetManually => _attributes[kGeolocationSetManually] == true;
  ...
  set latitude(double? x) => (x == null) ? _attributes.remove(kLatitude) : _attributes[kLatitude] = x;
  ///
  /// pass `null` to remove key from attributes
  set longitude(double? x) => (x == null) ? _attributes.remove(kLongitude) : _attributes[kLongitude] = x;
  ///
  /// pass `null` to remove key from attributes
  ...
  ///
  /// pass `null` to remove key from attributes
  set country(String? x) => (x == null) ? _attributes.remove(kCountry) : _attributes[kCountry] = x;
  ///
  /// pass `null` to remove key from attributes
  set phoneNumber(String? x) => (x == null) ? _attributes.remove(kPhoneNumber) : _attributes[kPhoneNumber] = x;
  ///
  /// pass `null` to remove key from attributes
  set website(String? x) => (x == null) ? _attributes.remove(kWebsite) : _attributes[kWebsite] = x;
  ///
  /// pass `null` to remove key from attributes
  set isTwentyFourHourTime(bool? x) => (x == null) ? _attributes.remove(kTwentyFourHourTime) : _attributes[kTwentyFourHourTime] = x;
  ///
  /// pass `null` to remove key from attributes
  set dateFormat(int? x) => (x == null) ? _attributes.remove(kDateFormat) : _attributes[kDateFormat] = x;
  ///
  /// pass `null` to remove key from attributes
  set isChurchCenterEnabled(bool? x) => (x == null) ? _attributes.remove(kChurchCenterEnabled) : _attributes[kChurchCenterEnabled] = x;
  ///
  /// pass `null` to remove key from attributes
  set contactEmailAddress(String? x) => (x == null) ? _attributes.remove(kContactEmailAddress) : _attributes[kContactEmailAddress] = x;
  ///
  /// pass `null` to remove key from attributes
  set timeZone(String? x) => (x == null) ? _attributes.remove(kTimeZone) : _attributes[kTimeZone] = x;
  ///
  /// pass `null` to remove key from attributes
  set isGeolocationSetManually(bool? x) => (x == null) ? _attributes.remove(kGeolocationSetManually) : _attributes[kGeolocationSetManually] = x;
  ///
  /// pass `null` to remove key from attributes
  ...
  List<PcoPeopleList> get includedLists => (relationships['lists'] as List?)?.cast<PcoPeopleList>() ?? [];
  List<PcoPeopleServiceTime> get includedServiceTimes => (relationships['service_times'] as List?)?.cast<PcoPeopleServiceTime>() ?? [];

  // Class Constructors
  PcoPeopleCampus.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleCampus({String? id, double? latitude, double? longitude, String? description, String? street, String? city, String? state, String? zip, String? country, String? phoneNumber, String? website, bool? isTwentyFourHourTime, int? dateFormat, bool? isChurchCenterEnabled, String? contactEmailAddress, String? timeZone, bool? isGeolocationSetManually, String? name, DateTime? createdAt, DateTime? updatedAt, String? avatarUrl, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isChurchCenterEnabled != null) obj._attributes['church_center_enabled'] = isChurchCenterEnabled;
    if (contactEmailAddress != null) obj._attributes['contact_email_address'] = contactEmailAddress;
    if (timeZone != null) obj._attributes['time_zone'] = timeZone;
    if (isGeolocationSetManually != null) obj._attributes['geolocation_set_manually'] = isGeolocationSetManually;
  ...
  static Future<PcoCollection<PcoPeopleCampus>> get( {String? id, PcoPeopleCampusQuery? query, bool includeAll = false, bool includeLists = false, bool includeServiceTimes = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleCampus>> getFromForm(String formId, {PcoPeopleCampusQuery? query, bool includeAll = false, bool includeLists = false, bool includeServiceTimes = false,}) async {
    query ??= PcoPeopleCampusQuery();
    if (includeAll) query.include.addAll(PcoPeopleCampus.canInclude);
    if (includeLists) query.include.add('lists');
    if (includeServiceTimes) query.include.add('service_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleCampus>> getFromList(String listId, {PcoPeopleCampusQuery? query, bool includeAll = false, bool includeLists = false, bool includeServiceTimes = false,}) async {
    query ??= PcoPeopleCampusQuery();
    if (includeAll) query.include.addAll(PcoPeopleCampus.canInclude);
    if (includeLists) query.include.add('lists');
    if (includeServiceTimes) query.include.add('service_times');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleCampus>> getPrimaryCampusFromPerson(String personId, {PcoPeopleCampusQuery? query, bool includeAll = false, bool includeLists = false, bool includeServiceTimes = false,}) async {
    query ??= PcoPeopleCampusQuery();
    if (includeAll) query.include.addAll(PcoPeopleCampus.canInclude);
    if (includeLists) query.include.add('lists');
    if (includeServiceTimes) query.include.add('service_times');
  ...
  Future<PcoCollection<PcoPeopleList>> getLists({PcoPeopleListQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleServiceTime>> getServiceTimes({PcoPeopleServiceTimeQuery? query}) async {
