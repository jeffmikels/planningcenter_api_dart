...
enum PcoPeopleConditionOrder { application, comparison, createdAt, definitionClass, definitionIdentifier, description, settings, updatedAt }
...
class PcoPeopleConditionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleConditionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleConditionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleConditionFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleConditionQuery({
    ...
    if (whereApplication != null) where.add(PlanningCenterApiWhere.parse('application', whereApplication));
    if (whereComparison != null) where.add(PlanningCenterApiWhere.parse('comparison', whereComparison));
    if (whereCreatedAt != null) where.add(PlanningCenterApiWhere.parse('created_at', whereCreatedAt));
    if (whereDefinitionClass != null) where.add(PlanningCenterApiWhere.parse('definition_class', whereDefinitionClass));
    if (whereDefinitionIdentifier != null) where.add(PlanningCenterApiWhere.parse('definition_identifier', whereDefinitionIdentifier));
    if (whereDescription != null) where.add(PlanningCenterApiWhere.parse('description', whereDescription));
    if (whereSettings != null) where.add(PlanningCenterApiWhere.parse('settings', whereSettings));
...
class PcoPeopleCondition extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleCondition>> getFromListAndRule(String listId,String ruleId, {String? id, PcoPeopleConditionQuery? query, bool includeCreatedBy = false,}) async {
