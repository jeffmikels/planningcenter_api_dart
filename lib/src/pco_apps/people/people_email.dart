...
class PcoPeopleEmail extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleEmail>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleEmail>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
