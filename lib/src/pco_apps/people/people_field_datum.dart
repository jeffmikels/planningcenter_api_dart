/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.724862
...
class PcoPeopleFieldDatum extends PcoResource {
  ...
  List<T> includedFieldDefinition<T extends PcoResource>() => relationships['field_definition']?.cast<T>() ?? [];
  List<T> includedFieldOption<T extends PcoResource>() => relationships['field_option']?.cast<T>() ?? [];
  List<T> includedTab<T extends PcoResource>() => relationships['tab']?.cast<T>() ?? [];
  ...
  static Future<PcoCollection<PcoPeopleFieldDatum>> get( {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoPeopleFieldDatum>> getFieldDataFromPeople(String peopleId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeopleFieldDatum.canInclude;
  ...
  Future<PcoCollection<PcoPeopleFieldDefinition>> getFieldDefinition({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleFieldOption>> getFieldOption({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
