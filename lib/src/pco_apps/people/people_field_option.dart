/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:51.404106
...
class PcoPeopleFieldOptionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleFieldOptionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleFieldOptionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleFieldOptionFilter filter) => _filterMap[filter]!;
...
class PcoPeopleFieldOption extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleFieldOption.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleFieldOption({required String fieldDefinitionId, String? id, String? value, int? sequence, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleFieldOption>> getFromFieldData(String fieldDataId, {PcoPeopleFieldOptionQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleFieldOption>> getFromFieldDefinition(String fieldDefinitionId, {String? id, PcoPeopleFieldOptionQuery? query, }) async {
    query ??= PcoPeopleFieldOptionQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleFieldOption>> getFromTab(String tabId, {String? id, PcoPeopleFieldOptionQuery? query, }) async {
    query ??= PcoPeopleFieldOptionQuery();
