...
class PcoPeopleForm extends PcoResource {
  ...
  /// - `recently_viewed`
  /// - `with_recoverable`
  static Future<PcoCollection<PcoPeopleForm>> get( {String? id, PlanningCenterApiQuery? query, bool includeCampus = false,}) async {
  ...
  Future<PcoCollection<PcoPeopleFormField>> getFields({PlanningCenterApiQuery? query, bool includeOptions = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleFormSubmission>> getFormSubmissions({PlanningCenterApiQuery? query, bool includeAll = false, bool includeFormFields = false, bool includeFormSubmissionValues = false, bool includePerson = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoPeopleForm.canInclude);
