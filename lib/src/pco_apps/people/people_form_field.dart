/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.482241
...
class PcoPeopleFormFieldQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleFormFieldOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleFormFieldFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleFormFieldFilter filter) => _filterMap[filter]!;
...
class PcoPeopleFormField extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleFormField>> getFieldsFromForm(String formId, {PcoPeopleFormFieldQuery? query, bool includeOptions = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleFormField>> getFromFormAndFormSubmission(String formId,String formSubmissionId, {String? id, PcoPeopleFormFieldQuery? query, bool includeOptions = false,}) async {
    query ??= PcoPeopleFormFieldQuery();
  ...
  Future<PcoCollection<PcoPeopleFormFieldOption>> getOptions({PcoPeopleFormFieldOptionQuery? query}) async {
