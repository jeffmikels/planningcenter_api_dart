/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.728653
...
class PcoPeopleFormSubmission extends PcoResource {
  ...
  List<T> includedFormFields<T extends PcoResource>() => relationships['form_fields']?.cast<T>() ?? [];
  List<T> includedFormSubmissionValues<T extends PcoResource>() => relationships['form_submission_values']?.cast<T>() ?? [];
