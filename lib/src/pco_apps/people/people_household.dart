...
enum PcoPeopleHouseholdOrder { createdAt, memberCount, name, primaryContactName, updatedAt }
...
class PcoPeopleHouseholdQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleHouseholdOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleHouseholdFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleHouseholdFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleHouseholdQuery({
    ...
    if (whereMemberCount != null) where.add(PlanningCenterApiWhere.parse('member_count', whereMemberCount));
    if (whereName != null) where.add(PlanningCenterApiWhere.parse('name', whereName));
    if (wherePrimaryContactName != null) where.add(PlanningCenterApiWhere.parse('primary_contact_name', wherePrimaryContactName));
...
class PcoPeopleHousehold extends PcoResource {
  ...
  ///
  /// pass `null` to remove key from attributes
  set memberCount(int? x) => (x == null) ? _attributes.remove(kMemberCount) : _attributes[kMemberCount] = x;
  ///
  /// pass `null` to remove key from attributes
  set avatar(String? x) => (x == null) ? _attributes.remove(kAvatar) : _attributes[kAvatar] = x;
  ///
  /// pass `null` to remove key from attributes
  set primaryContactId(String? x) => (x == null) ? _attributes.remove(kPrimaryContactId) : _attributes[kPrimaryContactId] = x;
  ...
  // Class Constructors
  PcoPeopleHousehold.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleHousehold({String? id, String? name, int? memberCount, String? primaryContactName, DateTime? createdAt, DateTime? updatedAt, String? avatar, String? primaryContactId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (primaryContactName != null) obj._attributes['primary_contact_name'] = primaryContactName;
    if (createdAt != null) obj._attributes['created_at'] = createdAt.toIso8601String();
    if (updatedAt != null) obj._attributes['updated_at'] = updatedAt.toIso8601String();
    if (avatar != null) obj._attributes['avatar'] = avatar;
    if (primaryContactId != null) obj._attributes['primary_contact_id'] = primaryContactId;
  ...
  static Future<PcoCollection<PcoPeopleHousehold>> get( {String? id, PcoPeopleHouseholdQuery? query, bool includePeople = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleHousehold>> getFromHouseholdAndHouseholdMembership(String householdId,String householdMembershipId, {PcoPeopleHouseholdQuery? query, bool includePeople = false,}) async {
    query ??= PcoPeopleHouseholdQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleHousehold>> getFromPeopleImportAndHistory(String peopleImportId,String historyId, {PcoPeopleHouseholdQuery? query, bool includePeople = false,}) async {
    query ??= PcoPeopleHouseholdQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleHousehold>> getFromPerson(String personId, {String? id, PcoPeopleHouseholdQuery? query, bool includePeople = false,}) async {
    query ??= PcoPeopleHouseholdQuery();
