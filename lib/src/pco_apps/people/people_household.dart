...
class PcoPeopleHousehold extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleHousehold>> get( {String? id, PlanningCenterApiQuery? query, bool includePeople = false,}) async {
  ...
  static Future<PcoCollection<PcoPeopleHousehold>> getFromHouseholdAndHouseholdMembership(String householdId,String householdMembershipId, {PlanningCenterApiQuery? query, bool includePeople = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoPeopleHousehold>> getFromPeopleImportAndHistory(String peopleImportId,String historyId, {PlanningCenterApiQuery? query, bool includePeople = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoPeopleHousehold>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includePeople = false,}) async {
    query ??= PlanningCenterApiQuery();
