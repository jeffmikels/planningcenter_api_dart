...
class PcoPeopleInactiveReason extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleInactiveReason>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleInactiveReason>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
