...
class PcoPeopleInactiveReasonQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleInactiveReasonOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleInactiveReasonFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleInactiveReasonFilter filter) => _filterMap[filter]!;
...
class PcoPeopleInactiveReason extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleInactiveReason.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleInactiveReason({String? id, String? value, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleInactiveReason>> get( {String? id, PcoPeopleInactiveReasonQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleInactiveReason>> getFromPerson(String personId, {String? id, PcoPeopleInactiveReasonQuery? query, }) async {
    query ??= PcoPeopleInactiveReasonQuery();
