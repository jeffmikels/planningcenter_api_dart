...
class PcoPeopleListCategoryQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleListCategoryOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleListCategoryFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleListCategoryFilter filter) => _filterMap[filter]!;
...
class PcoPeopleListCategory extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleListCategory.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleListCategory({String? id, String? name, DateTime? createdAt, DateTime? updatedAt, String? organizationId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleListCategory>> get( {String? id, PcoPeopleListCategoryQuery? query, bool includeLists = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleListCategory>> getCategoryFromList(String listId, {PcoPeopleListCategoryQuery? query, bool includeLists = false,}) async {
    query ??= PcoPeopleListCategoryQuery();
