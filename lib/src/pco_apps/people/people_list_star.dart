/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2023-01-02T22:03:21.103025
...
class PcoPeopleListStar extends PcoResource {
  ...
  /// using a path like this: `/people/v2/lists/$listId/star/[id]`
  ///
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoPeopleListStar?> getSingleStarFromList(
    String listId,
    String id, {
    PcoPeopleListStarQuery? query,
  }) async {
    ...
    var retval = await PcoCollection.fromApiCall<PcoPeopleListStar>(url,
        query: query, apiVersion: kApiVersion);
    return retval.items.isEmpty ? null : retval.items.first;
  }

  /// Will get a [PcoCollection] containing ALL [PcoPeopleListStar] objects (expecting many)
  /// using a path like this: `/people/v2/lists/$listId/star`
  ///
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  ...
  static Future<PcoCollection<PcoPeopleListStar>> getAllStarFromList(
    String listId, {
    String? id,
    PcoPeopleListStarQuery? query,
  }) async {
