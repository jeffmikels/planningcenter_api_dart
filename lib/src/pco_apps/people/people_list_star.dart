...
class PcoPeopleListStarQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleListStarOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleListStarFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleListStarFilter filter) => _filterMap[filter]!;
...
class PcoPeopleListStar extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleListStar.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleListStar({String? id, DateTime? createdAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleListStar>> getStarFromList(String listId, {String? id, PcoPeopleListStarQuery? query, }) async {
