/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2023-01-02T22:03:21.103661
...
class PcoPeopleMaritalStatusQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleMaritalStatusOrder order,
          {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleMaritalStatusFilter, String> _filterMap = {};
  static String filterString(PcoPeopleMaritalStatusFilter filter) =>
      _filterMap[filter]!;
...
class PcoPeopleMaritalStatus extends PcoResource {
  ...
  factory PcoPeopleMaritalStatus(
      {String? id,
      String? value,
