/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.725130
...
/// - Manually create an object using the `PcoPeopleMaritalStatus.manual()` constructor.
...
class PcoPeopleMaritalStatus extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleMaritalStatus>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleMaritalStatus>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
