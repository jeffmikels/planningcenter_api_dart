/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.735019
...
class PcoPeopleMessage extends PcoResource {
  ...
  List<T> includedMessageGroup<T extends PcoResource>() => relationships['message_group']?.cast<T>() ?? [];
  List<T> includedTo<T extends PcoResource>() => relationships['to']?.cast<T>() ?? [];
  ...
  /// - `created_after`
  static Future<PcoCollection<PcoPeopleMessage>> get( {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoPeopleMessage>> getFromMessageGroup(String messageGroupId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeopleMessage.canInclude;
  ...
  /// - `sent`
  /// - `unread`
  static Future<PcoCollection<PcoPeopleMessage>> getFromPeople(String peopleId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeopleMessage.canInclude;
  ...
  Future<PcoCollection<PcoPeopleMessageGroup>> getMessageGroup({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeoplePerson>> getTo({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
