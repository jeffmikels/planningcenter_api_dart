/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:51.412108
...
class PcoPeopleNamePrefixQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleNamePrefixOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleNamePrefixFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleNamePrefixFilter filter) => _filterMap[filter]!;
...
class PcoPeopleNamePrefix extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleNamePrefix>> get( {String? id, PcoPeopleNamePrefixQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleNamePrefix>> getFromPerson(String personId, {String? id, PcoPeopleNamePrefixQuery? query, }) async {
    query ??= PcoPeopleNamePrefixQuery();
