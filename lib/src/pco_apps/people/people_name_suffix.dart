/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.726859
...
/// - Manually create an object using the `PcoPeopleNameSuffix.manual()` constructor.
...
class PcoPeopleNameSuffix extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleNameSuffix>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleNameSuffix>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
