...
class PcoPeopleNoteCategory extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleNoteCategory>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeShares = false, bool includeSubscribers = false, bool includeSubscriptions = false,}) async {
  ...
  static Future<PcoCollection<PcoPeopleNoteCategory>> getCategoryFromNote(String noteId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includeShares = false, bool includeSubscribers = false, bool includeSubscriptions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoPeopleNoteCategory.canInclude);
    if (includeShares) query.include.add('shares');
    if (includeSubscribers) query.include.add('subscribers');
  ...
  Future<PcoCollection<PcoPeopleNoteCategoryShare>> getShares({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleNoteCategorySubscription>> getSubscriptions({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
