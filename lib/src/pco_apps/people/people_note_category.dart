/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.741664
...
class PcoPeopleNoteCategory extends PcoResource {
  ...
  List<T> includedSubscribers<T extends PcoResource>() => relationships['subscribers']?.cast<T>() ?? [];
  List<T> includedSubscriptions<T extends PcoResource>() => relationships['subscriptions']?.cast<T>() ?? [];
