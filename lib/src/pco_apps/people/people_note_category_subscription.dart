...
class PcoPeopleNoteCategorySubscription extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleNoteCategorySubscription>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoPeopleNoteCategorySubscription>> getSubscriptionsFromNoteCategory(String noteCategoryId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
