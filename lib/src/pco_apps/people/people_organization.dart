...
class PcoPeopleOrganizationQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleOrganizationOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleOrganizationFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleOrganizationFilter filter) => _filterMap[filter]!;
...
class PcoPeopleOrganization extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleOrganization>> getFromPerson(String personId, {String? id, PcoPeopleOrganizationQuery? query, }) async {
  ...
  Future<PcoCollection<PcoPeopleAnniversaryCouple>> getAnniversaryCouples({PcoPeopleAnniversaryCoupleQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleBirthdayPerson>> getBirthdayPeople({PcoPeopleBirthdayPersonQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleCampus>> getCampuses({PcoPeopleCampusQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleCarrier>> getCarriers({PcoPeopleCarrierQuery? query}) async {
  ...
  /// 
  Future<PcoCollection<PcoPeopleFieldDefinition>> getFieldDefinitions({PcoPeopleFieldDefinitionQuery? query}) async {
  ...
  /// - `recently_viewed`
  /// - `with_recoverable`
  Future<PcoCollection<PcoPeopleForm>> getForms({PcoPeopleFormQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleInactiveReason>> getInactiveReasons({PcoPeopleInactiveReasonQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleListCategory>> getListCategories({PcoPeopleListCategoryQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleMaritalStatus>> getMaritalStatuses({PcoPeopleMaritalStatusQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleNamePrefix>> getNamePrefixes({PcoPeopleNamePrefixQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleNameSuffix>> getNameSuffixes({PcoPeopleNameSuffixQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleNoteCategorySubscription>> getNoteCategorySubscriptions({PcoPeopleNoteCategorySubscriptionQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeoplePeopleImport>> getPeopleImports({PcoPeoplePeopleImportQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeoplePersonMerger>> getPersonMergers({PcoPeoplePersonMergerQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleSchoolOption>> getSchoolOptions({PcoPeopleSchoolOptionQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleOrganizationStatistic>> getStats({PcoPeopleOrganizationStatisticQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleTab>> getTabs({PcoPeopleTabQuery? query}) async {
  ...
  /// - `with_recoverable`
  /// - `with_steps`
  Future<PcoCollection<PcoPeopleWorkflow>> getWorkflows({PcoPeopleWorkflowQuery? query}) async {
