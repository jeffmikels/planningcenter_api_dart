...
class PcoPeoplePeopleImportQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeoplePeopleImportOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeoplePeopleImportFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeoplePeopleImportFilter filter) => _filterMap[filter]!;
...
class PcoPeoplePeopleImport extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeoplePeopleImport>> get( {String? id, PcoPeoplePeopleImportQuery? query, }) async {
  ...
  /// - `not_ignored`
  /// - `updates`
  Future<PcoCollection<PcoPeoplePeopleImportConflict>> getConflicts({PcoPeoplePeopleImportConflictQuery? query}) async {
  ...
  /// - `identical`
  /// - `updates`
  Future<PcoCollection<PcoPeoplePeopleImportHistory>> getHistories({PcoPeoplePeopleImportHistoryQuery? query}) async {
