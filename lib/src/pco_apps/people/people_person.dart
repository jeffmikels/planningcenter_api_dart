/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T18:03:47.687350
...
class PcoPeoplePerson extends PcoResource {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeoplePerson>> getFromNoteCategoryAndShare(
    ...
    if (includeSocialProfiles) query.include.add('social_profiles');
    var url =
        '/people/v2/note_categories/$noteCategoryId/shares/$shareId/person';
  ...
  static Future<PcoCollection<PcoPeoplePerson>>
    ...
    if (includeSocialProfiles) query.include.add('social_profiles');
    var url =
        '/people/v2/people/$personId/workflow_cards/$workflowCardId/assignee';
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromPersonAndWorkflowCard(
    ...
    if (includeSocialProfiles) query.include.add('social_profiles');
    var url =
        '/people/v2/people/$personId/workflow_cards/$workflowCardId/person';
