/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.750682
...
class PcoPeoplePerson extends PcoResource {
  ...
  List<T> includedAddresses<T extends PcoResource>() => relationships['addresses']?.cast<T>() ?? [];
  List<T> includedEmails<T extends PcoResource>() => relationships['emails']?.cast<T>() ?? [];
  List<T> includedFieldData<T extends PcoResource>() => relationships['field_data']?.cast<T>() ?? [];
  List<T> includedHouseholds<T extends PcoResource>() => relationships['households']?.cast<T>() ?? [];
  List<T> includedInactiveReason<T extends PcoResource>() => relationships['inactive_reason']?.cast<T>() ?? [];
  List<T> includedMaritalStatus<T extends PcoResource>() => relationships['marital_status']?.cast<T>() ?? [];
  List<T> includedNamePrefix<T extends PcoResource>() => relationships['name_prefix']?.cast<T>() ?? [];
  List<T> includedNameSuffix<T extends PcoResource>() => relationships['name_suffix']?.cast<T>() ?? [];
  List<T> includedOrganization<T extends PcoResource>() => relationships['organization']?.cast<T>() ?? [];
  List<T> includedPersonApps<T extends PcoResource>() => relationships['person_apps']?.cast<T>() ?? [];
  List<T> includedPhoneNumbers<T extends PcoResource>() => relationships['phone_numbers']?.cast<T>() ?? [];
  List<T> includedPlatformNotifications<T extends PcoResource>() => relationships['platform_notifications']?.cast<T>() ?? [];
  List<T> includedPrimaryCampus<T extends PcoResource>() => relationships['primary_campus']?.cast<T>() ?? [];
  List<T> includedSchool<T extends PcoResource>() => relationships['school']?.cast<T>() ?? [];
  List<T> includedSocialProfiles<T extends PcoResource>() => relationships['social_profiles']?.cast<T>() ?? [];
  ...
  /// 
  /// - `organization_admins`
  static Future<PcoCollection<PcoPeoplePerson>> get( {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getCreatedByFromListAndRuleAndCondition(String listId,String ruleId,String conditionId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromEmail(String emailId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromFieldData(String fieldDataId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromFormAndFormSubmission(String formId,String formSubmissionId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromHouseholdAndHouseholdMembership(String householdId,String householdMembershipId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  /// - `non_pending`
  /// - `without_deceased`
  static Future<PcoCollection<PcoPeoplePerson>> getPeopleFromHousehold(String householdId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getCreatedByFromList(String listId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getPeopleFromList(String listId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromListAndShare(String listId,String shareId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getUpdatedByFromList(String listId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromFromMessageGroup(String messageGroupId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getToFromMessage(String messageId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getSubscribersFromNoteCategory(String noteCategoryId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getCreatedByFromNote(String noteId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromNote(String noteId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromPeopleImportAndHistory(String peopleImportId,String historyId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getCreatedByFromReport(String reportId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getUpdatedByFromReport(String reportId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromSocialProfile(String socialProfileId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getAssigneeFromPeopleAndWorkflowCard(String peopleId,String workflowCardId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromPeopleAndWorkflowCard(String peopleId,String workflowCardId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromPeopleAndWorkflowShare(String peopleId,String workflowShareId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getSharedPeopleFromWorkflow(String workflowId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getFromWorkflowAndStepAndAssigneeSummary(String workflowId,String stepId,String assigneeSummaryId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  static Future<PcoCollection<PcoPeoplePerson>> getDefaultAssigneeFromWorkflowAndStep(String workflowId,String stepId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoPeoplePerson.canInclude;
  ...
  Future<PcoCollection<PcoPeopleConnectedPerson>> getConnectedPeople({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleInactiveReason>> getInactiveReason({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleNamePrefix>> getNamePrefix({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleNameSuffix>> getNameSuffix({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleOrganization>> getOrganization({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleCampus>> getPrimaryCampus({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleSchoolOption>> getSchool({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
