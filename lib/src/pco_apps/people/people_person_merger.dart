...
class PcoPeoplePersonMergerQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeoplePersonMergerOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeoplePersonMergerFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeoplePersonMergerFilter filter) => _filterMap[filter]!;
  ...
  PcoPeoplePersonMergerQuery({
    ...
    if (wherePersonToKeepId != null) where.add(PlanningCenterApiWhere.parse('person_to_keep_id', wherePersonToKeepId));
    if (wherePersonToRemoveId != null) where.add(PlanningCenterApiWhere.parse('person_to_remove_id', wherePersonToRemoveId));
...
class PcoPeoplePersonMerger extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeoplePersonMerger>> get( {String? id, PcoPeoplePersonMergerQuery? query, }) async {
