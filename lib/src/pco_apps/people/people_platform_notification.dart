...
class PcoPeoplePlatformNotification extends PcoResource {
  ...
  factory PcoPeoplePlatformNotification(
      {String? id,
      String? html,
  ...
  /// using a path like this: `/people/v2/people/$personId/platform_notifications/[id]`
  ///
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoPeoplePlatformNotification?> getSingleFromPerson(
    String personId,
    String id, {
    PcoPeoplePlatformNotificationQuery? query,
  }) async {
    ...
    var url = '/people/v2/people/$personId/platform_notifications/$id';
    var retval = await PcoCollection.fromApiCall<PcoPeoplePlatformNotification>(
        url,
        query: query,
  ...
  /// Will get a [PcoCollection] containing ALL [PcoPeoplePlatformNotification] objects (expecting many)
  /// using a path like this: `/people/v2/people/$personId/platform_notifications`
  ///
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  ...
  static Future<PcoCollection<PcoPeoplePlatformNotification>> getAllFromPerson(
    String personId, {
    String? id,
    PcoPeoplePlatformNotificationQuery? query,
  }) async {
