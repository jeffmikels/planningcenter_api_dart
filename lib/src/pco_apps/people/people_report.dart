...
class PcoPeopleReport extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleReport>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeCreatedBy = false, bool includeUpdatedBy = false,}) async {
