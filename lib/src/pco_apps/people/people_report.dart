...
class PcoPeopleReportQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleReportOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleReportFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleReportFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleReportQuery({
    ...
    if (whereBody != null) where.add(PlanningCenterApiWhere.parse('body', whereBody));
...
class PcoPeopleReport extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleReport.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleReport({String? id, String? name, String? body, DateTime? createdAt, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleReport>> get( {String? id, PcoPeopleReportQuery? query, bool includeAll = false, bool includeCreatedBy = false, bool includeUpdatedBy = false,}) async {
