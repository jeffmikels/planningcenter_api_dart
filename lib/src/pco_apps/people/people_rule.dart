...
class PcoPeopleRuleQuery extends PlanningCenterApiQuery {
  ...
  PcoPeopleRuleQuery({
    ...
    if (whereSubset != null) where.add(PlanningCenterApiWhere.parse('subset', whereSubset));
...
class PcoPeopleRule extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleRule>> getFromList(String listId, {String? id, PcoPeopleRuleQuery? query, bool includeConditions = false,}) async {
  ...
  Future<PcoCollection<PcoPeopleCondition>> getConditions({PcoPeopleConditionQuery? query}) async {
