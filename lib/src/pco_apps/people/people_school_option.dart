/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:51.427223
...
class PcoPeopleSchoolOptionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleSchoolOptionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleSchoolOptionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleSchoolOptionFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleSchoolOptionQuery({
    ...
    if (whereBeginningGrade != null) where.add(PlanningCenterApiWhere.parse('beginning_grade', whereBeginningGrade));
    if (whereEndingGrade != null) where.add(PlanningCenterApiWhere.parse('ending_grade', whereEndingGrade));
    if (whereSchoolTypes != null) where.add(PlanningCenterApiWhere.parse('school_types', whereSchoolTypes));
...
class PcoPeopleSchoolOption extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleSchoolOption>> get( {String? id, PcoPeopleSchoolOptionQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleSchoolOption>> getSchoolFromPerson(String personId, {String? id, PcoPeopleSchoolOptionQuery? query, }) async {
    query ??= PcoPeopleSchoolOptionQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleSchoolOption>> getPromotesToSchoolFromSchoolOption(String schoolOptionId, {String? id, PcoPeopleSchoolOptionQuery? query, }) async {
    query ??= PcoPeopleSchoolOptionQuery();
  ...
  Future<PcoCollection<PcoPeopleSchoolOption>> getPromotesToSchool({PcoPeopleSchoolOptionQuery? query}) async {
    query ??= PcoPeopleSchoolOptionQuery();
