...
class PcoPeopleSocialProfileQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleSocialProfileOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleSocialProfileFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleSocialProfileFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleSocialProfileQuery({
    ...
    if (whereSite != null) where.add(PlanningCenterApiWhere.parse('site', whereSite));
    ...
    if (whereVerified != null) where.add(PlanningCenterApiWhere.parse('verified', whereVerified));
...
class PcoPeopleSocialProfile extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleSocialProfile>> get( {String? id, PcoPeopleSocialProfileQuery? query, bool includePerson = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleSocialProfile>> getFromPerson(String personId, {String? id, PcoPeopleSocialProfileQuery? query, bool includePerson = false,}) async {
    query ??= PcoPeopleSocialProfileQuery();
