/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.771993
...
class PcoPeopleTab extends PcoResource {
  ...
  List<T> includedFieldDefinitions<T extends PcoResource>() => relationships['field_definitions']?.cast<T>() ?? [];
  List<T> includedFieldOptions<T extends PcoResource>() => relationships['field_options']?.cast<T>() ?? [];
