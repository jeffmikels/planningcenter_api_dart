...
class PcoPeopleWorkflow extends PcoResource {
  ...
  /// - `with_recoverable`
  /// - `with_steps`
  static Future<PcoCollection<PcoPeopleWorkflow>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeCategory = false, bool includeShares = false, bool includeSteps = false,}) async {
  ...
  static Future<PcoCollection<PcoPeopleWorkflow>> getFromPersonAndWorkflowCard(String personId,String workflowCardId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includeCategory = false, bool includeShares = false, bool includeSteps = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoPeopleWorkflow.canInclude);
    if (includeCategory) query.include.add('category');
    if (includeShares) query.include.add('shares');
  ...
  Future<PcoCollection<PcoPeopleWorkflowCard>> getCards({PlanningCenterApiQuery? query, bool includeAll = false, bool includeAssignee = false, bool includeCurrentStep = false, bool includePerson = false, bool includeWorkflow = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoPeopleWorkflow.canInclude);
  ...
  Future<PcoCollection<PcoPeopleWorkflowCategory>> getCategory({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleWorkflowShare>> getShares({PlanningCenterApiQuery? query, bool includePerson = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoPeopleWorkflowStep>> getSteps({PlanningCenterApiQuery? query, bool includeDefaultAssignee = false,}) async {
    query ??= PlanningCenterApiQuery();
