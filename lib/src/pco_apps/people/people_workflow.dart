...
class PcoPeopleWorkflowQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleWorkflowOrder order, {bool reverse = false}) =>
  ...
  static String filterString(PcoPeopleWorkflowFilter filter) => _filterMap[filter]!;
  ...
  PcoPeopleWorkflowQuery({
    ...
    if (whereCampusId != null) where.add(PlanningCenterApiWhere.parse('campus_id', whereCampusId));
    if (whereCreatedAt != null) where.add(PlanningCenterApiWhere.parse('created_at', whereCreatedAt));
    if (whereDeletedAt != null) where.add(PlanningCenterApiWhere.parse('deleted_at', whereDeletedAt));
    ...
    if (whereWorkflowCategoryId != null) where.add(PlanningCenterApiWhere.parse('workflow_category_id', whereWorkflowCategoryId));
...
class PcoPeopleWorkflow extends PcoResource {
  ...
  int get totalReadyAndSnoozedCardCount => _attributes[kTotalReadyAndSnoozedCardCount] ?? 0;
  ...
  ///
  /// pass `null` to remove key from attributes
  set workflowCategoryId(String? x) => (x == null) ? _attributes.remove(kWorkflowCategoryId) : _attributes[kWorkflowCategoryId] = x;
  ...
  /// The code generator could not automatically determine the resource type of this relationship.
  /// For type safe code, you should specify it in the type argument when calling.
  List<T> includedSteps<T extends PcoResource>() => (relationships['steps'] as List?)?.cast<T>() ?? [];
  

  // Class Constructors
  PcoPeopleWorkflow.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleWorkflow({String? id, String? name, int? myReadyCardCount, int? totalReadyCardCount, int? completedCardCount, int? totalCardsCount, int? totalReadyAndSnoozedCardCount, DateTime? createdAt, DateTime? updatedAt, DateTime? deletedAt, String? campusId, String? workflowCategoryId, int? myOverdueCardCount, int? myDueSoonCardCount, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (myReadyCardCount != null) obj._attributes['my_ready_card_count'] = myReadyCardCount;
    if (totalReadyCardCount != null) obj._attributes['total_ready_card_count'] = totalReadyCardCount;
    if (completedCardCount != null) obj._attributes['completed_card_count'] = completedCardCount;
    if (totalCardsCount != null) obj._attributes['total_cards_count'] = totalCardsCount;
    if (totalReadyAndSnoozedCardCount != null) obj._attributes['total_ready_and_snoozed_card_count'] = totalReadyAndSnoozedCardCount;
  ...
  static Future<PcoCollection<PcoPeopleWorkflow>> get( {String? id, PcoPeopleWorkflowQuery? query, bool includeAll = false, bool includeCategory = false, bool includeShares = false, bool includeSteps = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleWorkflow>> getFromPersonAndWorkflowCard(String personId,String workflowCardId, {PcoPeopleWorkflowQuery? query, bool includeAll = false, bool includeCategory = false, bool includeShares = false, bool includeSteps = false,}) async {
    query ??= PcoPeopleWorkflowQuery();
    if (includeAll) query.include.addAll(PcoPeopleWorkflow.canInclude);
    if (includeCategory) query.include.add('category');
    if (includeShares) query.include.add('shares');
  ...
  Future<PcoCollection<PcoPeopleWorkflowCard>> getCards({PcoPeopleWorkflowCardQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleWorkflowCategory>> getCategory({PcoPeopleWorkflowCategoryQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeoplePerson>> getSharedPeople({PcoPeoplePersonQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleWorkflowShare>> getShares({PcoPeopleWorkflowShareQuery? query}) async {
  ...
  Future<PcoCollection<PcoPeopleWorkflowStep>> getSteps({PcoPeopleWorkflowStepQuery? query}) async {
