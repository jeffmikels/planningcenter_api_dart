...
class PcoPeopleWorkflowCardQuery extends PlanningCenterApiQuery {
  static final Map<PcoPeopleWorkflowCardOrder, String> _orderMap = {
    ...
    PcoPeopleWorkflowCardOrder.flaggedForNotificationAt: 'flagged_for_notification_at',
  ...
  static String orderString(PcoPeopleWorkflowCardOrder order, {bool reverse = false}) =>
  ...
  PcoPeopleWorkflowCardQuery({
    ...
    if (whereStage != null) where.add(PlanningCenterApiWhere.parse('stage', whereStage));
...
class PcoPeopleWorkflowCard extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowCard>> getFromPerson(String personId, {String? id, PcoPeopleWorkflowCardQuery? query, bool includeAll = false, bool includeAssignee = false, bool includeCurrentStep = false, bool includePerson = false, bool includeWorkflow = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleWorkflowCard>> getCardsFromWorkflow(String workflowId, {PcoPeopleWorkflowCardQuery? query, bool includeAll = false, bool includeAssignee = false, bool includeCurrentStep = false, bool includePerson = false, bool includeWorkflow = false,}) async {
    query ??= PcoPeopleWorkflowCardQuery();
    if (includeAll) query.include.addAll(PcoPeopleWorkflowCard.canInclude);
    if (includeAssignee) query.include.add('assignee');
    if (includeCurrentStep) query.include.add('current_step');
