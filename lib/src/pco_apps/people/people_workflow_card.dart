/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.776088
...
class PcoPeopleWorkflowCard extends PcoResource {
  ...
  List<T> includedAssignee<T extends PcoResource>() => relationships['assignee']?.cast<T>() ?? [];
  List<T> includedCurrentStep<T extends PcoResource>() => relationships['current_step']?.cast<T>() ?? [];
  List<T> includedPerson<T extends PcoResource>() => relationships['person']?.cast<T>() ?? [];
  List<T> includedWorkflow<T extends PcoResource>() => relationships['workflow']?.cast<T>() ?? [];
