...
class PcoPeopleWorkflowCardNote extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowCardNote>> getNotesFromPersonAndWorkflowCard(String personId,String workflowCardId, {PlanningCenterApiQuery? query, }) async {
