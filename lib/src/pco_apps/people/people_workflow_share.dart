/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:51.435380
...
class PcoPeopleWorkflowShareQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoPeopleWorkflowShareOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleWorkflowShareFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleWorkflowShareFilter filter) => _filterMap[filter]!;
...
class PcoPeopleWorkflowShare extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleWorkflowShare.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoPeopleWorkflowShare({required String workflowId, String? id, String? group, String? permission, String? personId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowShare>> getFromPerson(String personId, {String? id, PcoPeopleWorkflowShareQuery? query, bool includePerson = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoPeopleWorkflowShare>> getSharesFromWorkflow(String workflowId, {PcoPeopleWorkflowShareQuery? query, bool includePerson = false,}) async {
    query ??= PcoPeopleWorkflowShareQuery();
