/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.761423
...
/// - Manually create an object using the `PcoPeopleWorkflowShare.manual()` constructor.
...
class PcoPeopleWorkflowShare extends PcoResource {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowShare>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includePerson = false,}) async {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowShare>> getSharesFromWorkflow(String workflowId, {PlanningCenterApiQuery? query, bool includePerson = false,}) async {
    query ??= PlanningCenterApiQuery();
