...
class PcoPeopleWorkflowStepAssigneeSummaryQuery extends PlanningCenterApiQuery {
  static final Map<PcoPeopleWorkflowStepAssigneeSummaryOrder, String> _orderMap = {
    
  };
  static String orderString(PcoPeopleWorkflowStepAssigneeSummaryOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoPeopleWorkflowStepAssigneeSummaryFilter, String> _filterMap = {
    
  };
  static String filterString(PcoPeopleWorkflowStepAssigneeSummaryFilter filter) => _filterMap[filter]!;
...
class PcoPeopleWorkflowStepAssigneeSummary extends PcoResource {
  ...
  // Class Constructors
  PcoPeopleWorkflowStepAssigneeSummary.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  PcoPeopleWorkflowStepAssigneeSummary.empty() : super(kPcoApplication, kTypeString);
  ...
  factory PcoPeopleWorkflowStepAssigneeSummary({String? id, int? readyCount, int? snoozedCount, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoPeopleWorkflowStepAssigneeSummary>> getAssigneeSummariesFromWorkflowAndStep(String workflowId,String stepId, {PcoPeopleWorkflowStepAssigneeSummaryQuery? query, bool includePerson = false,}) async {
