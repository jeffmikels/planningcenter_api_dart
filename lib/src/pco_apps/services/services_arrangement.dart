/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.584504
...
class PcoServicesArrangement extends PcoResource {
  ...
  List<T> includedKeys<T extends PcoResource>() => relationships['keys']?.cast<T>() ?? [];
  List<T> includedSections<T extends PcoResource>() => relationships['sections']?.cast<T>() ?? [];
