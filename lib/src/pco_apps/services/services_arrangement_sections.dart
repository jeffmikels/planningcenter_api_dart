/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.288998
...
class PcoServicesArrangementSectionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesArrangementSectionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesArrangementSectionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesArrangementSectionFilter filter) => _filterMap[filter]!;
...
class PcoServicesArrangementSection extends PcoResource {
  ...
  // Class Constructors
  PcoServicesArrangementSection.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesArrangementSection({String? id, List? sections, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoServicesArrangementSection>> getSectionsFromSongAndArrangement(String songId,String arrangementId, {String? id, PcoServicesArrangementSectionQuery? query, }) async {
