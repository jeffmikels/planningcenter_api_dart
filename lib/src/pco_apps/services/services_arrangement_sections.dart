/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.545757
...
/// - Manually create an object using the `PcoServicesArrangementSection.manual()` constructor.
...
class PcoServicesArrangementSection extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesArrangementSection>> getSectionsFromSongAndArrangement(String songId,String arrangementId, {String? id, PlanningCenterApiQuery? query, }) async {
