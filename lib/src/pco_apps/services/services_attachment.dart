/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:11.934078
...
/// - `size` -> `?order=size`
enum PcoServicesAttachmentOrder { attachableType, createdAt, filename, filetype, size }
...
class PcoServicesAttachmentQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesAttachmentOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesAttachmentFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesAttachmentFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesAttachmentQuery({
    ...
    if (whereLicensesPurchased != null) where.add(PlanningCenterApiWhere.parse('licenses_purchased', whereLicensesPurchased));
...
class PcoServicesAttachment extends PcoResource {
  ...
  set pageOrder(String? x) => (x == null) ? _attributes.remove(kPageOrder) : _attributes[kPageOrder] = x;
  ///
  /// pass `null` to remove key from attributes
  set filename(String? x) => (x == null) ? _attributes.remove(kFilename) : _attributes[kFilename] = x;
  ///
  /// pass `null` to remove key from attributes
  set remoteLink(String? x) => (x == null) ? _attributes.remove(kRemoteLink) : _attributes[kRemoteLink] = x;
  ///
  /// pass `null` to remove key from attributes
  set fileUploadIdentifier(String? x) => (x == null) ? _attributes.remove(kFileUploadIdentifier) : _attributes[kFileUploadIdentifier] = x;
  
  // additional setters / getters for create/update attributes
  ///
  /// pass `null` to remove key from attributes
  set attachmentTypeIds(String? x) => (x == null) ? _attributes.remove(kAttachmentTypeIds) : _attributes[kAttachmentTypeIds] = x;
  String get attachmentTypeIds => _attributes[kAttachmentTypeIds] ?? '';
  
  // typed getters for each relationship
  
  List<PcoServicesZoom> get includedZooms => (relationships['zooms'] as List?)?.cast<PcoServicesZoom>() ?? [];

  // Class Constructors
  PcoServicesAttachment.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesAttachment({required String songId, required String arrangementId, String? id, DateTime? createdAt, String? pageOrder, DateTime? updatedAt, String? filename, int? fileSize, int? licensesPurchased, int? licensesRemaining, int? licensesUsed, String? contentType, String? displayName, String? filetype, String? linkedUrl, String? pcoType, String? remoteLink, String? thumbnailUrl, String? url, bool? isAllowMp3Download, bool? isWebStreamable, bool? isDownloadable, bool? isTransposable, bool? isStreamable, bool? isHasPreview, String? fileUploadIdentifier, String? attachmentTypeIds, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (licensesPurchased != null) obj._attributes['licenses_purchased'] = licensesPurchased;
    if (licensesRemaining != null) obj._attributes['licenses_remaining'] = licensesRemaining;
    ...
    if (isWebStreamable != null) obj._attributes['web_streamable'] = isWebStreamable;
    if (isDownloadable != null) obj._attributes['downloadable'] = isDownloadable;
    if (isTransposable != null) obj._attributes['transposable'] = isTransposable;
    ...
    if (fileUploadIdentifier != null) obj._attributes['file_upload_identifier'] = fileUploadIdentifier;
    if (attachmentTypeIds != null) obj._attributes['attachment_type_ids'] = attachmentTypeIds;
  ...
  static Future<PcoCollection<PcoServicesAttachment>> getFromSongAndArrangement(String songId,String arrangementId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromServiceTypeAndPlanAndItem(String serviceTypeId,String planId,String itemId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getSelectedAttachmentFromServiceTypeAndPlanAndItem(String serviceTypeId,String planId,String itemId, {PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getSelectedBackgroundFromServiceTypeAndPlanAndItem(String serviceTypeId,String planId,String itemId, {PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromSongAndArrangementAndKey(String songId,String arrangementId,String keyId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromMedia(String mediaId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getAllAttachmentsFromServiceTypeAndPlan(String serviceTypeId,String planId, {PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromServiceType(String serviceTypeId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesAttachment>> getFromSong(String songId, {String? id, PcoServicesAttachmentQuery? query, bool includeZooms = false,}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  Future<PcoCollection<PcoServicesZoom>> getZooms({PcoServicesZoomQuery? query}) async {
