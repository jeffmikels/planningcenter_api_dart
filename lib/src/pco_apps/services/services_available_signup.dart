/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:11.937191
...
class PcoServicesAvailableSignupQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesAvailableSignupOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesAvailableSignupFilter, String> _filterMap = {
    PcoServicesAvailableSignupFilter.currentOrganization: 'current_organization',
  };
  static String filterString(PcoServicesAvailableSignupFilter filter) => _filterMap[filter]!;
...
class PcoServicesAvailableSignup extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesAvailableSignup>> getFromPerson(String personId, {String? id, PcoServicesAvailableSignupQuery? query, bool includeSignupSheets = false,}) async {
  ...
  Future<PcoCollection<PcoServicesSignupSheet>> getSignupSheets({PcoServicesSignupSheetQuery? query}) async {
