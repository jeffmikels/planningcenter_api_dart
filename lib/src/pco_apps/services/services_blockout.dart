/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.297082
...
class PcoServicesBlockoutQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesBlockoutOrder order, {bool reverse = false}) =>
  ...
  static String filterString(PcoServicesBlockoutFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesBlockoutQuery({
    ...
    if (whereGroupIdentifier != null) where.add(PlanningCenterApiWhere.parse('group_identifier', whereGroupIdentifier));}
}
...
class PcoServicesBlockout extends PcoResource {
  ...
  set reason(String? x) => (x == null) ? _attributes.remove(kReason) : _attributes[kReason] = x;
  ...
  ///
  /// pass `null` to remove key from attributes
  set repeatFrequency(String? x) => (x == null) ? _attributes.remove(kRepeatFrequency) : _attributes[kRepeatFrequency] = x;
  ...
  ///
  /// pass `null` to remove key from attributes
  set repeatInterval(String? x) => (x == null) ? _attributes.remove(kRepeatInterval) : _attributes[kRepeatInterval] = x;
  ...
  ///
  /// pass `null` to remove key from attributes
  set repeatPeriod(String? x) => (x == null) ? _attributes.remove(kRepeatPeriod) : _attributes[kRepeatPeriod] = x;
  ///
  /// pass `null` to remove key from attributes
  set repeatUntil(String? x) => (x == null) ? _attributes.remove(kRepeatUntil) : _attributes[kRepeatUntil] = x;
  ///
  /// pass `null` to remove key from attributes
  ...
  ///
  /// pass `null` to remove key from attributes
  set isShare(bool? x) => (x == null) ? _attributes.remove(kShare) : _attributes[kShare] = x;

  // Class Constructors
  PcoServicesBlockout.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesBlockout({required String personId, String? id, String? description, String? groupIdentifier, String? organizationName, String? reason, String? repeatFrequency, String? repeatInterval, String? repeatPeriod, String? settings, String? timeZone, DateTime? createdAt, DateTime? updatedAt, String? repeatUntil, DateTime? startsAt, DateTime? endsAt, bool? isShare, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    var obj = PcoServicesBlockout.empty();
    obj._id = id;
    obj._apiPathOverride = 'https://api.planningcenteronline.com/services/v2/people/$personId/blockouts';
    if (description != null) obj._attributes['description'] = description;
    if (groupIdentifier != null) obj._attributes['group_identifier'] = groupIdentifier;
    if (organizationName != null) obj._attributes['organization_name'] = organizationName;
    if (reason != null) obj._attributes['reason'] = reason;
    if (repeatFrequency != null) obj._attributes['repeat_frequency'] = repeatFrequency;
    if (repeatInterval != null) obj._attributes['repeat_interval'] = repeatInterval;
  ...
  static Future<PcoCollection<PcoServicesBlockout>> getFromPerson(String personId, {String? id, PcoServicesBlockoutQuery? query, }) async {
  ...
  Future<PcoCollection<PcoServicesBlockoutDate>> getBlockoutDates({PcoServicesBlockoutDateQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesBlockoutException>> getBlockoutExceptions({PcoServicesBlockoutExceptionQuery? query}) async {
