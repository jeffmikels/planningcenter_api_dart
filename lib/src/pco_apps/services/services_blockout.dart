...
class PcoServicesBlockout extends PcoResource {
  ...
  /// - `future`
  /// - `past`
  static Future<PcoCollection<PcoServicesBlockout>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  Future<PcoCollection<PcoServicesBlockoutDate>> getBlockoutDates({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesBlockoutException>> getBlockoutExceptions({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
