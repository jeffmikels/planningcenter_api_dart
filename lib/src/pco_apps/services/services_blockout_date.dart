...
class PcoServicesBlockoutDate extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesBlockoutDate>> getFromPersonAndBlockout(String personId,String blockoutId, {String? id, PlanningCenterApiQuery? query, }) async {
