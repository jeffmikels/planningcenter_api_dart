/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:11.939657
...
class PcoServicesBlockoutExceptionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesBlockoutExceptionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesBlockoutExceptionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesBlockoutExceptionFilter filter) => _filterMap[filter]!;
...
class PcoServicesBlockoutException extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesBlockoutException>> getFromPersonAndBlockout(String personId,String blockoutId, {String? id, PcoServicesBlockoutExceptionQuery? query, }) async {
