...
class PcoServicesFolder extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesFolder>> get( {String? id, PlanningCenterApiQuery? query, bool includeServiceTypes = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesFolder>> getFromFolder(String folderId, {String? id, PlanningCenterApiQuery? query, bool includeServiceTypes = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesFolder>> getFromTagGroup(String tagGroupId, {PlanningCenterApiQuery? query, bool includeServiceTypes = false,}) async {
    query ??= PlanningCenterApiQuery();
