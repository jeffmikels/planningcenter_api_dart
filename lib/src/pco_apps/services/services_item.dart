...
class PcoServicesItem extends PcoResource {
  ...
  List get customArrangementSequence => _attributes[kCustomArrangementSequence] ?? [];
  List get customArrangementSequenceShort => _attributes[kCustomArrangementSequenceShort] ?? [];
  List get customArrangementSequenceFull => _attributes[kCustomArrangementSequenceFull] ?? [];
  ...
  /// pass `null` to remove key from attributes
  set itemType(String? x) => (x == null) ? _attributes.remove(kItemType) : _attributes[kItemType] = x;
  
  /// pass `null` to remove key from attributes
  set htmlDetails(String? x) => (x == null) ? _attributes.remove(kHtmlDetails) : _attributes[kHtmlDetails] = x;
  ...
  /// pass `null` to remove key from attributes
  set servicePosition(String? x) => (x == null) ? _attributes.remove(kServicePosition) : _attributes[kServicePosition] = x;
  ...
  /// pass `null` to remove key from attributes
  set customArrangementSequence(List? x) => (x == null) ? _attributes.remove(kCustomArrangementSequence) : _attributes[kCustomArrangementSequence] = x;
  
  // additional setters / getters for create/update attributes
  
  /// pass `null` to remove key from attributes
  set arrangementId(String? x) => (x == null) ? _attributes.remove(kArrangementId) : _attributes[kArrangementId] = x;
  String get arrangementId => _attributes[kArrangementId] ?? '';
  
  /// pass `null` to remove key from attributes
  set keyId(String? x) => (x == null) ? _attributes.remove(kKeyId) : _attributes[kKeyId] = x;
  String get keyId => _attributes[kKeyId] ?? '';
  
  /// pass `null` to remove key from attributes
  set selectedLayoutId(String? x) => (x == null) ? _attributes.remove(kSelectedLayoutId) : _attributes[kSelectedLayoutId] = x;
  String get selectedLayoutId => _attributes[kSelectedLayoutId] ?? '';
  
  /// pass `null` to remove key from attributes
  set songId(String? x) => (x == null) ? _attributes.remove(kSongId) : _attributes[kSongId] = x;
  String get songId => _attributes[kSongId] ?? '';
  
  // typed getters for each relationship
  
  PcoServicesArrangement? get includedArrangement => _firstOrNull<PcoServicesArrangement>(relationships['arrangement']);
  List<PcoServicesItemNote> get includedItemNotes => (relationships['item_notes'] as List?)?.cast<PcoServicesItemNote>() ?? [];
  List<PcoServicesItemTime> get includedItemTimes => (relationships['item_times'] as List?)?.cast<PcoServicesItemTime>() ?? [];
  PcoServicesKey? get includedKey => _firstOrNull<PcoServicesKey>(relationships['key']);
  PcoServicesMedia? get includedMedia => _firstOrNull<PcoServicesMedia>(relationships['media']);
  /// The code generator could not automatically determine the resource type of this relationship.
  /// For type safe code, you should specify it here.
  List<T> includedSelectedAttachment<T extends PcoResource>() => (relationships['selected_attachment'] as List?)?.cast<T>() ?? [];
  PcoServicesSong? get includedSong => _firstOrNull<PcoServicesSong>(relationships['song']);

  // Class Constructors
  PcoServicesItem.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesItem({required String serviceTypeId, required String planId, String? id, String? title, int? sequence, DateTime? createdAt, DateTime? updatedAt, int? length, String? itemType, String? htmlDetails, String? servicePosition, String? description, String? keyName, List? customArrangementSequence, List? customArrangementSequenceShort, List? customArrangementSequenceFull, String? arrangementId, String? keyId, String? selectedLayoutId, String? songId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (servicePosition != null) obj._attributes['service_position'] = servicePosition;
    if (description != null) obj._attributes['description'] = description;
    if (keyName != null) obj._attributes['key_name'] = keyName;
    if (customArrangementSequence != null) obj._attributes['custom_arrangement_sequence'] = customArrangementSequence;
    if (customArrangementSequenceShort != null) obj._attributes['custom_arrangement_sequence_short'] = customArrangementSequenceShort;
    if (customArrangementSequenceFull != null) obj._attributes['custom_arrangement_sequence_full'] = customArrangementSequenceFull;
    if (arrangementId != null) obj._attributes['arrangement_id'] = arrangementId;
    if (keyId != null) obj._attributes['key_id'] = keyId;
    if (selectedLayoutId != null) obj._attributes['selected_layout_id'] = selectedLayoutId;
  ...
  static Future<PcoCollection<PcoServicesItem>> getFromPersonAndRecentPlanAndLive(String personId,String recentPlanId,String liveId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesItem>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  static Future<PcoCollection<PcoServicesItem>> getFromServiceTypeAndPlanTemplate(String serviceTypeId,String planTemplateId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  static Future<PcoCollection<PcoServicesItem>> getLastScheduledItemFromSong(String songId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  Future<PcoCollection<PcoServicesArrangement>> getArrangement({PlanningCenterApiQuery? query, bool includeAll = false, bool includeKeys = false, bool includeSections = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
  ...
  Future<PcoCollection<PcoServicesCcliReporting>> getCcliReporting({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesCustomSlide>> getCustomSlides({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesItemNote>> getItemNotes({PlanningCenterApiQuery? query, bool includeItemNoteCategory = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesItemTime>> getItemTimes({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesKey>> getKey({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesMedia>> getMedia({PlanningCenterApiQuery? query, bool includeAttachments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesAttachment>> getSelectedAttachment({PlanningCenterApiQuery? query, bool includeZooms = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesAttachment>> getSelectedBackground({PlanningCenterApiQuery? query, bool includeZooms = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesSong>> getSong({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
