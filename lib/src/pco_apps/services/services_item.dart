...
class PcoServicesItemQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesItemOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesItemFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesItemFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesItemQuery({
    ...
    if (includeAll || includeSelectedAttachment) include.add('selected_attachment');
...
class PcoServicesItem extends PcoResource {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesItem>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PcoServicesItemQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PcoServicesItemQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesItem>> getFromServiceTypeAndPlanTemplate(String serviceTypeId,String planTemplateId, {String? id, PcoServicesItemQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PcoServicesItemQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesItem>> getLastScheduledItemFromSong(String songId, {PcoServicesItemQuery? query, bool includeAll = false, bool includeArrangement = false, bool includeItemNotes = false, bool includeItemTimes = false, bool includeKey = false, bool includeMedia = false, bool includeSelectedAttachment = false, bool includeSong = false,}) async {
    query ??= PcoServicesItemQuery();
    if (includeAll) query.include.addAll(PcoServicesItem.canInclude);
    if (includeArrangement) query.include.add('arrangement');
    if (includeItemNotes) query.include.add('item_notes');
  ...
  Future<PcoCollection<PcoServicesArrangement>> getArrangement({PcoServicesArrangementQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesCustomSlide>> getCustomSlides({PcoServicesCustomSlideQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesItemNote>> getItemNotes({PcoServicesItemNoteQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesItemTime>> getItemTimes({PcoServicesItemTimeQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesKey>> getKey({PcoServicesKeyQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesMedia>> getMedia({PcoServicesMediaQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesAttachment>> getSelectedAttachment({PcoServicesAttachmentQuery? query}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  Future<PcoCollection<PcoServicesAttachment>> getSelectedBackground({PcoServicesAttachmentQuery? query}) async {
    query ??= PcoServicesAttachmentQuery();
  ...
  Future<PcoCollection<PcoServicesSong>> getSong({PcoServicesSongQuery? query}) async {
