/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.607231
...
class PcoServicesItemNote extends PcoResource {
  ...
  set content(String? x) =>
      (x == null) ? attributes.remove(kContent) : attributes[kContent] = x;

  // getters for each relationship
  // the code generator cannot determine the resource type of the relationships

  List<T> includedItemNoteCategory<T extends PcoResource>() =>
      relationships['item_note_category']?.cast<T>() ?? [];
