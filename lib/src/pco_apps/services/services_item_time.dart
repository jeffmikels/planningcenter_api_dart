/// This file was generated on 2021-11-18T13:57:09.720565
...
class PcoServicesItemTime extends PcoResource {
  ...
  static const String typeString = 'ItemTime';
  static const String typeId = 'item_time';
  static const String apiVersion = '2018-11-01';
  static const String shortestEdgeId = '';
  static const String shortestEdgePathTemplate = 'https://api.planningcenteronline.com/services/v2/songs/1/last_scheduled_item/1/item_times';
  ...
  PcoServicesItemTime() : super(pcoApplication, typeString);
  PcoServicesItemTime.fromJson(Map<String, dynamic> data): super.fromJson(pcoApplication, typeString, data);
  ...
  static Future<List<PcoServicesItemTime>> getManyFromServiceTypeAndPlanAndItemAndItemTimeIds(String serviceTypeId,String planId,String itemId, {PlanningCenterApiQuery? query}) async {
  ...
  static Future<List<PcoServicesItemTime>> getManyFromPeopleAndRecentPlanAndLiveAndCurrentItemTimeIds(String peopleId,String recentPlanId,String liveId, {PlanningCenterApiQuery? query}) async {
    List<PcoServicesItemTime> retval = [];
    query ??= PlanningCenterApiQuery();
  ...
  static Future<List<PcoServicesItemTime>> getManyFromPeopleAndRecentPlanAndLiveAndItemTimeIds(String peopleId,String recentPlanId,String liveId, {PlanningCenterApiQuery? query}) async {
    List<PcoServicesItemTime> retval = [];
    query ??= PlanningCenterApiQuery();
  ...
  /// using a path like this: https://api.planningcenteronline.com/services/v2/service_types/1/plans/1/items/1/item_times;
  static Future<PcoServicesItemTime?> getSingleFromServiceTypeAndPlanAndItemAndItemTimeIds(String serviceTypeId,String planId,String itemId, String id, {PlanningCenterApiQuery? query}) async {
    ...
    if (res.data is! List) {
      retval = PcoServicesItemTime.fromJson(res.data);
    }
    return retval;
  }
  /// will get a single PcoServicesItemTime Object
  /// using a path like this: https://api.planningcenteronline.com/services/v2/people/1/recent_plans/1/live/1/current_item_time;
  static Future<PcoServicesItemTime?> getSingleFromPeopleAndRecentPlanAndLiveAndCurrentItemTimeIds(String peopleId,String recentPlanId,String liveId, String id, {PlanningCenterApiQuery? query}) async {
    PcoServicesItemTime?  retval;
    query ??= PlanningCenterApiQuery();
  ...
  /// will get a single PcoServicesItemTime Object
  /// using a path like this: https://api.planningcenteronline.com/services/v2/people/1/recent_plans/1/live/1/next_item_time;
  static Future<PcoServicesItemTime?> getSingleFromPeopleAndRecentPlanAndLiveAndItemTimeIds(String peopleId,String recentPlanId,String liveId, String id, {PlanningCenterApiQuery? query}) async {
    PcoServicesItemTime?  retval;
    query ??= PlanningCenterApiQuery();
