...
class PcoServicesKey extends PcoResource {
  ...
  static const String typeString = 'Key';
  static const String typeId = 'key';
  static const String apiVersion = '2018-11-01';
  static const String shortestEdgeId = 'key-arrangement-keys';
  static const String shortestEdgePathTemplate = 'https://api.planningcenteronline.com/services/v2/songs/1/arrangements/1/keys';
  ...
  PcoServicesKey() : super(pcoApplication, typeString);
  PcoServicesKey.fromJson(Map<String, dynamic> data): super.fromJson(pcoApplication, typeString, data);
