/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.311710
...
class PcoServicesLiveControllerQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesLiveControllerOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesLiveControllerFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesLiveControllerFilter filter) => _filterMap[filter]!;
...
class PcoServicesLiveController extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesLiveController>> getFromServiceType(String serviceTypeId, {String? id, PcoServicesLiveControllerQuery? query, }) async {
