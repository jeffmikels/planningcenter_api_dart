/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.576945
...
/// - Manually create an object using the `PcoServicesNeededPosition.manual()` constructor.
...
class PcoServicesNeededPosition extends PcoResource {
  ...
  /// pass `null` to remove key from attributes
  set timeId(String? x) => (x == null) ? _attributes.remove(kTimeId) : _attributes[kTimeId] = x;
  String get timeId => _attributes[kTimeId] ?? '';
  
  /// pass `null` to remove key from attributes
  set timePreferenceOptionId(String? x) => (x == null) ? _attributes.remove(kTimePreferenceOptionId) : _attributes[kTimePreferenceOptionId] = x;
  String get timePreferenceOptionId => _attributes[kTimePreferenceOptionId] ?? '';
  ...
  List<T> includedTime<T extends PcoResource>() => (relationships['time'] as List?)?.cast<T>() ?? [];

  // Class Constructors
  PcoServicesNeededPosition.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesNeededPosition({required String serviceTypeId, required String planId, String? id, int? quantity, String? teamPositionName, String? scheduledTo, String? timeId, String? timePreferenceOptionId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (timePreferenceOptionId != null) obj._attributes['time_preference_option_id'] = timePreferenceOptionId;
  ...
  static Future<PcoCollection<PcoServicesNeededPosition>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includeTeam = false, bool includeTime = false,}) async {
  ...
  Future<PcoCollection<PcoServicesPlanTime>> getTime({PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
