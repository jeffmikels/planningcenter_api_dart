...
class PcoServicesNeededPositionQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesNeededPositionOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesNeededPositionFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesNeededPositionFilter filter) => _filterMap[filter]!;
...
class PcoServicesNeededPosition extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesNeededPosition>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PcoServicesNeededPositionQuery? query, bool includeAll = false, bool includeTeam = false, bool includeTime = false,}) async {
