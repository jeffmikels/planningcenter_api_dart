...
class PcoServicesPersonQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesPersonOrder order, {bool reverse = false}) =>
...
class PcoServicesPerson extends PcoResource {
  ...
  Future<PcoCollection<PcoServicesAvailableSignup>> getAvailableSignups({PcoServicesAvailableSignupQuery? query}) async {
  ...
  /// - `future`
  /// - `past`
  Future<PcoCollection<PcoServicesBlockout>> getBlockouts({PcoServicesBlockoutQuery? query}) async {
  ...
  /// - `past`
  Future<PcoCollection<PcoServicesSchedule>> getSchedules({PcoServicesScheduleQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesTextSetting>> getTextSettings({PcoServicesTextSettingQuery? query}) async {
