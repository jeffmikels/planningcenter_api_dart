...
class PcoServicesPerson extends PcoResource {
  ...
  bool get isAssignedToRehearsalTeam => _attributes[kAssignedToRehearsalTeam] == true;
  ...
  bool get isAccessMediaAttachments => _attributes[kAccessMediaAttachments] == true;
  bool get isAccessPlanAttachments => _attributes[kAccessPlanAttachments] == true;
  bool get isAccessSongAttachments => _attributes[kAccessSongAttachments] == true;
  ...
  set preferredApp(String? x) => (x == null) ? _attributes.remove(kPreferredApp) : _attributes[kPreferredApp] = x;
  
  /// pass `null` to remove key from attributes
  set permissions(String? x) => (x == null) ? _attributes.remove(kPermissions) : _attributes[kPermissions] = x;
  
  /// pass `null` to remove key from attributes
  set isAccessMediaAttachments(bool? x) => (x == null) ? _attributes.remove(kAccessMediaAttachments) : _attributes[kAccessMediaAttachments] = x;
  
  /// pass `null` to remove key from attributes
  set isAccessPlanAttachments(bool? x) => (x == null) ? _attributes.remove(kAccessPlanAttachments) : _attributes[kAccessPlanAttachments] = x;
  
  /// pass `null` to remove key from attributes
  set isAccessSongAttachments(bool? x) => (x == null) ? _attributes.remove(kAccessSongAttachments) : _attributes[kAccessSongAttachments] = x;
  
  /// pass `null` to remove key from attributes
  set onboardings(List? x) => (x == null) ? _attributes.remove(kOnboardings) : _attributes[kOnboardings] = x;
  ...
  factory PcoServicesPerson({String? id, String? photoUrl, String? photoThumbnailUrl, String? preferredApp, bool? isAssignedToRehearsalTeam, DateTime? archivedAt, DateTime? createdAt, String? firstName, String? lastName, String? namePrefix, String? nameSuffix, DateTime? updatedAt, String? facebookId, String? legacyId, String? fullName, String? maxPermissions, String? permissions, String? status, DateTime? anniversary, DateTime? birthdate, String? givenName, String? middleName, String? nickname, bool? isAccessMediaAttachments, bool? isAccessPlanAttachments, bool? isAccessSongAttachments, bool? isArchived, bool? isSiteAdministrator, DateTime? loggedInAt, String? notes, bool? isPassedBackgroundCheck, String? icalCode, bool? isPraiseChartsEnabled, String? meTab, String? plansTab, String? songsTab, String? mediaTab, String? peopleTab, bool? isCanEditAllPeople, bool? isCanViewAllPeople, List? onboardings, String? currentFolderId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isAssignedToRehearsalTeam != null) obj._attributes['assigned_to_rehearsal_team'] = isAssignedToRehearsalTeam;
    ...
    if (maxPermissions != null) obj._attributes['max_permissions'] = maxPermissions;
    if (permissions != null) obj._attributes['permissions'] = permissions;
    if (status != null) obj._attributes['status'] = status;
    if (anniversary != null) obj._attributes['anniversary'] = anniversary.toIso8601String();
    if (birthdate != null) obj._attributes['birthdate'] = birthdate.toIso8601String();
    ...
    if (isAccessMediaAttachments != null) obj._attributes['access_media_attachments'] = isAccessMediaAttachments;
    if (isAccessPlanAttachments != null) obj._attributes['access_plan_attachments'] = isAccessPlanAttachments;
    if (isAccessSongAttachments != null) obj._attributes['access_song_attachments'] = isAccessSongAttachments;
    ...
    if (loggedInAt != null) obj._attributes['logged_in_at'] = loggedInAt.toIso8601String();
    ...
    if (isCanEditAllPeople != null) obj._attributes['can_edit_all_people'] = isCanEditAllPeople;
    if (isCanViewAllPeople != null) obj._attributes['can_view_all_people'] = isCanViewAllPeople;
    if (onboardings != null) obj._attributes['onboardings'] = onboardings;
    if (currentFolderId != null) obj._attributes['current_folder_id'] = currentFolderId;
  ...
  static Future<PcoCollection<PcoServicesPerson>> get( {String? id, PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoServicesPerson>> getControllerFromPersonAndRecentPlanAndLive(String personId,String recentPlanId,String liveId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPerson>> getFromServiceTypeAndTeamPositionAndPersonTeamPositionAssignment(String serviceTypeId,String teamPositionId,String personTeamPositionAssignmentId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPerson>> getFromPersonAndPlanPerson(String personId,String planPersonId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPerson>> getRespondToFromPersonAndSchedule(String personId,String scheduleId, {PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPerson>> getFromPersonAndAssignedTeamLeader(String personId,String assignedTeamLeaderId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPerson>> getFromTeam(String teamId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesAvailableSignup>> getAvailableSignups({PlanningCenterApiQuery? query, bool includeSignupSheets = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `future`
  /// - `past`
  Future<PcoCollection<PcoServicesBlockout>> getBlockouts({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `past`
  Future<PcoCollection<PcoServicesSchedule>> getSchedules({PlanningCenterApiQuery? query, bool includePlanTimes = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesTextSetting>> getTextSettings({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
