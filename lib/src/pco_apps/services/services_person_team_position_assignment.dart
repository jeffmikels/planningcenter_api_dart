/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.581107
...
/// - Manually create an object using the `PcoServicesPersonTeamPositionAssignment.manual()` constructor.
...
class PcoServicesPersonTeamPositionAssignment extends PcoResource {
  ...
  /// - `not_archived`
  /// - `not_deleted`
  static Future<PcoCollection<PcoServicesPersonTeamPositionAssignment>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includePerson = false, bool includeTeamPosition = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesPersonTeamPositionAssignment>> getFromTeam(String teamId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includePerson = false, bool includeTeamPosition = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesPersonTeamPositionAssignment.canInclude);
    if (includePerson) query.include.add('person');
    if (includeTeamPosition) query.include.add('team_position');
  ...
  /// 
  static Future<PcoCollection<PcoServicesPersonTeamPositionAssignment>> getFromServiceTypeAndTeamPosition(String serviceTypeId,String teamPositionId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includePerson = false, bool includeTeamPosition = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesPersonTeamPositionAssignment.canInclude);
    if (includePerson) query.include.add('person');
    if (includeTeamPosition) query.include.add('team_position');
  ...
  Future<PcoCollection<PcoServicesTeamPosition>> getTeamPosition({PlanningCenterApiQuery? query, bool includeTeam = false,}) async {
    query ??= PlanningCenterApiQuery();
