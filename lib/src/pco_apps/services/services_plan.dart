/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.616841
...
class PcoServicesPlan extends PcoResource {
  ...
  List<T> includedContributors<T extends PcoResource>() => relationships['contributors']?.cast<T>() ?? [];
  List<T> includedMySchedules<T extends PcoResource>() => relationships['my_schedules']?.cast<T>() ?? [];
  List<T> includedPlanTimes<T extends PcoResource>() => relationships['plan_times']?.cast<T>() ?? [];
  List<T> includedSeries<T extends PcoResource>() => relationships['series']?.cast<T>() ?? [];
  ...
  static Future<PcoCollection<PcoServicesPlan>> getWatchablePlansFromPeopleAndRecentPlanAndLive(String peopleId,String recentPlanId,String liveId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoServicesPlan>> getNextPlanFromServiceTypeAndPlan(String serviceTypeId,String planId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  static Future<PcoCollection<PcoServicesPlan>> getFromPeopleAndPlanPeople(String peopleId,String planPeopleId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  static Future<PcoCollection<PcoServicesPlan>> getPreviousPlanFromServiceTypeAndPlan(String serviceTypeId,String planId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  static Future<PcoCollection<PcoServicesPlan>> getFromSeries(String seriesId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  /// - `no_dates`
  /// - `past`
  static Future<PcoCollection<PcoServicesPlan>> getFromServiceType(String serviceTypeId, {String? id, PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  /// Available Query Filters:
  /// - `deleted`
  static Future<PcoCollection<PcoServicesPlan>> getUnscopedPlansFromServiceType(String serviceTypeId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  /// 
  Future<PcoCollection<PcoServicesAttachment>> getAllAttachments({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesLive>> getLive({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesSchedule>> getMySchedules({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlan>> getNextPlan({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  Future<PcoCollection<PcoServicesPlanNote>> getNotes({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlan>> getPreviousPlan({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlan.canInclude;
  ...
  Future<PcoCollection<PcoServicesTeam>> getSignupTeams({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `not_archived`
  /// - `not_deleted`
  Future<PcoCollection<PcoServicesPlanPerson>> getTeamMembers({PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
