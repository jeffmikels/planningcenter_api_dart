/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.584272
...
/// - Manually create an object using the `PcoServicesPlanNote.manual()` constructor.
...
class PcoServicesPlanNote extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesPlanNote>> getNotesFromServiceTypeAndPlan(String serviceTypeId,String planId, {PlanningCenterApiQuery? query, bool includePlanNoteCategory = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesPlanNote>> getNotesFromServiceTypeAndPlanTemplate(String serviceTypeId,String planTemplateId, {PlanningCenterApiQuery? query, bool includePlanNoteCategory = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlanNoteCategory>> getPlanNoteCategory({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
