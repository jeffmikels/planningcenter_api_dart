/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.617494
...
class PcoServicesPlanNote extends PcoResource {
  ...
  List<T> includedPlanNoteCategory<T extends PcoResource>() => relationships['plan_note_category']?.cast<T>() ?? [];
