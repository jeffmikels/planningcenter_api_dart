/// This file was generated on 2021-11-25T00:07:20.270224
...
class PcoServicesPlanNoteCategory extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getManyFromServiceTypeAndPlanTemplateAndNote(String serviceTypeId,String planTemplateId,String noteId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getManyFromServiceTypeAndPlanNoteCategory(String serviceTypeId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlanNoteCategory.canInclude;
  ...
  /// using a path like this: https://api.planningcenteronline.com/services/v2/service_types/1/plan_templates/1/notes/1/plan_note_category;
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getSingleFromServiceTypeAndPlanTemplateAndNote(String serviceTypeId,String planTemplateId,String noteId, String id, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlanNoteCategory.canInclude;
  ...
  /// will get a single PcoServicesPlanNoteCategory Object
  /// using a path like this: https://api.planningcenteronline.com/services/v2/service_types/1/plan_note_categories;
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getSingleFromServiceTypeAndPlanNoteCategory(String serviceTypeId, String id, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesPlanNoteCategory.canInclude;
