/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.584733
...
/// - Manually create an object using the `PcoServicesPlanNoteCategory.manual()` constructor.
...
class PcoServicesPlanNoteCategory extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getFromServiceTypeAndPlanTemplateAndNote(String serviceTypeId,String planTemplateId,String noteId, {PlanningCenterApiQuery? query, }) async {
  ...
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getFromServiceType(String serviceTypeId, {String? id, PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
