/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.330951
...
class PcoServicesPlanNoteCategoryQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesPlanNoteCategoryOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesPlanNoteCategoryFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesPlanNoteCategoryFilter filter) => _filterMap[filter]!;
...
class PcoServicesPlanNoteCategory extends PcoResource {
  ...
  // Class Constructors
  PcoServicesPlanNoteCategory.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesPlanNoteCategory({String? id, DateTime? createdAt, DateTime? deletedAt, String? name, int? sequence, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getFromServiceTypeAndPlanTemplateAndNote(String serviceTypeId,String planTemplateId,String noteId, {PcoServicesPlanNoteCategoryQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesPlanNoteCategory>> getFromServiceType(String serviceTypeId, {String? id, PcoServicesPlanNoteCategoryQuery? query, }) async {
    query ??= PcoServicesPlanNoteCategoryQuery();
