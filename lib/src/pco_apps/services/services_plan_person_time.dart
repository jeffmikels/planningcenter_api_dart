/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:11.963199
...
class PcoServicesPlanPersonTimeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesPlanPersonTimeOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesPlanPersonTimeFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesPlanPersonTimeFilter filter) => _filterMap[filter]!;
...
class PcoServicesPlanPersonTime extends PcoResource {
  ...
  // Class Constructors
  PcoServicesPlanPersonTime.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesPlanPersonTime({String? id, String? status, DateTime? createdAt, DateTime? updatedAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoServicesPlanPersonTime>> getFromPersonAndPlanPerson(String personId,String planPersonId, {String? id, PcoServicesPlanPersonTimeQuery? query, }) async {
    query ??= PcoServicesPlanPersonTimeQuery();
    
    
    var url = '/services/v2/people/$personId/plan_people/$planPersonId/plan_person_times';
    if (id != null) url += '/$id';
