...
class PcoServicesPlanTime extends PcoResource {
  ...
  /// pass `null` to remove key from attributes
  set timeType(int? x) => (x == null) ? _attributes.remove(kTimeType) : _attributes[kTimeType] = x;
  ...
  factory PcoServicesPlanTime({required String serviceTypeId, required String planId, String? id, DateTime? createdAt, DateTime? updatedAt, String? name, int? timeType, bool? isRecorded, List? teamReminders, DateTime? startsAt, DateTime? endsAt, DateTime? liveStartsAt, DateTime? liveEndsAt, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getTimeFromPersonAndUpPlanAndNeededPosition(String personId,String upPlanId,String neededPositionId, {PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getDeclinedPlanTimesFromPersonAndPlanPerson(String personId,String planPersonId, {PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getFromPersonAndPlanPerson(String personId,String planPersonId, {String? id, PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getFromServiceTypeAndPlan(String serviceTypeId,String planId, {String? id, PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getDeclinedPlanTimesFromPersonAndSchedule(String personId,String scheduleId, {PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesPlanTime>> getFromPersonAndSchedule(String personId,String scheduleId, {String? id, PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `named`
  /// - `past`
  static Future<PcoCollection<PcoServicesPlanTime>> getFromServiceType(String serviceTypeId, {String? id, PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesSplitTeamRehearsalAssignment>> getSplitTeamRehearsalAssignments({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
