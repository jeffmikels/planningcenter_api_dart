/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-03-19T09:51:55.061713
...
class PcoServicesPlanTime extends PcoResource {
  ...
  factory PcoServicesPlanTime(String serviceTypeId, String planId,
      {DateTime? startsAt,
      DateTime? endsAt,
      String? name,
      int? timeType,
  ...
  Future<PcoCollection<PcoServicesSplitTeamRehearsalAssignment>>
    ...
    query ??= PlanningCenterApiQuery();
    if (allIncludes)
      query.include = PcoServicesSplitTeamRehearsalAssignment.canInclude;
