/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.591435
...
/// - Manually create an object using the `PcoServicesSchedule.manual()` constructor.
...
class PcoServicesSchedule extends PcoResource {
  ...
  /// - `past`
  static Future<PcoCollection<PcoServicesSchedule>> getFromPerson(String personId, {String? id, PlanningCenterApiQuery? query, bool includePlanTimes = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesSchedule>> getMySchedulesFromServiceTypeAndPlan(String serviceTypeId,String planId, {PlanningCenterApiQuery? query, bool includePlanTimes = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPerson>> getRespondTo({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
