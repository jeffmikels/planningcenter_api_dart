...
class PcoServicesSchedulingPreferenceQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesSchedulingPreferenceOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesSchedulingPreferenceFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesSchedulingPreferenceFilter filter) => _filterMap[filter]!;
...
class PcoServicesSchedulingPreference extends PcoResource {
  ...
  static const String kDefaultPathTemplate = 'https://api.planningcenteronline.com/services/v2/people/1/scheduling_preferences';
  ...
  // Class Constructors
  PcoServicesSchedulingPreference.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesSchedulingPreference({String? id, String? preference, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoServicesSchedulingPreference>> getFromPerson(String personId, {String? id, PcoServicesSchedulingPreferenceQuery? query, }) async {
    query ??= PcoServicesSchedulingPreferenceQuery();
    
    
    var url = '/services/v2/people/$personId/scheduling_preferences';
    if (id != null) url += '/$id';
    return PcoCollection.fromApiCall<PcoServicesSchedulingPreference>(url, query: query, apiVersion:kApiVersion);
  }
