/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.601080
...
/// - Manually create an object using the `PcoServicesServiceType.manual()` constructor.
...
class PcoServicesServiceType extends PcoResource {
  ...
  bool get isAttachmentTypesEnabled => _attributes[kAttachmentTypesEnabled] == true;
  String get backgroundCheckPermissions => _attributes[kBackgroundCheckPermissions] ?? '';
  ...
  /// pass `null` to remove key from attributes
  set isAttachmentTypesEnabled(bool? x) => (x == null) ? _attributes.remove(kAttachmentTypesEnabled) : _attributes[kAttachmentTypesEnabled] = x;
  
  /// pass `null` to remove key from attributes
  set backgroundCheckPermissions(String? x) => (x == null) ? _attributes.remove(kBackgroundCheckPermissions) : _attributes[kBackgroundCheckPermissions] = x;
  
  /// pass `null` to remove key from attributes
  set commentPermissions(String? x) => (x == null) ? _attributes.remove(kCommentPermissions) : _attributes[kCommentPermissions] = x;
  ...
  /// pass `null` to remove key from attributes
  set customItemTypes(String? x) => (x == null) ? _attributes.remove(kCustomItemTypes) : _attributes[kCustomItemTypes] = x;
  
  /// pass `null` to remove key from attributes
  set frequency(String? x) => (x == null) ? _attributes.remove(kFrequency) : _attributes[kFrequency] = x;
  
  /// pass `null` to remove key from attributes
  set lastPlanFrom(String? x) => (x == null) ? _attributes.remove(kLastPlanFrom) : _attributes[kLastPlanFrom] = x;
  ...
  /// pass `null` to remove key from attributes
  set standardItemTypes(String? x) => (x == null) ? _attributes.remove(kStandardItemTypes) : _attributes[kStandardItemTypes] = x;
  ...
  List<PcoServicesTimePreferenceOption> get includedTimePreferenceOptions => (relationships['time_preference_options'] as List?)?.cast<PcoServicesTimePreferenceOption>() ?? [];

  // Class Constructors
  PcoServicesServiceType.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesServiceType({String? id, DateTime? archivedAt, DateTime? createdAt, DateTime? deletedAt, String? name, int? sequence, DateTime? updatedAt, bool? isAttachmentTypesEnabled, String? backgroundCheckPermissions, String? commentPermissions, String? customItemTypes, String? frequency, String? lastPlanFrom, String? permissions, String? standardItemTypes, String? parentId, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isAttachmentTypesEnabled != null) obj._attributes['attachment_types_enabled'] = isAttachmentTypesEnabled;
    if (backgroundCheckPermissions != null) obj._attributes['background_check_permissions'] = backgroundCheckPermissions;
    if (commentPermissions != null) obj._attributes['comment_permissions'] = commentPermissions;
    if (customItemTypes != null) obj._attributes['custom_item_types'] = customItemTypes;
    ...
    if (standardItemTypes != null) obj._attributes['standard_item_types'] = standardItemTypes;
  ...
  /// - `no_parent`
  static Future<PcoCollection<PcoServicesServiceType>> get( {String? id, PlanningCenterApiQuery? query, bool includeTimePreferenceOptions = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesServiceType>> getFromFolder(String folderId, {String? id, PlanningCenterApiQuery? query, bool includeTimePreferenceOptions = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesServiceType>> getFromPersonAndRecentPlanAndLive(String personId,String recentPlanId,String liveId, {PlanningCenterApiQuery? query, bool includeTimePreferenceOptions = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  static Future<PcoCollection<PcoServicesServiceType>> getFromTeam(String teamId, {PlanningCenterApiQuery? query, bool includeTimePreferenceOptions = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesItemNoteCategory>> getItemNoteCategories({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesLayout>> getLayouts({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesLiveController>> getLiveControllers({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlanNoteCategory>> getPlanNoteCategories({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlanTemplate>> getPlanTemplates({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// - `named`
  /// - `past`
  Future<PcoCollection<PcoServicesPlanTime>> getPlanTimes({PlanningCenterApiQuery? query, bool includeSplitTeamRehearsalAssignments = false,}) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPublicView>> getPublicView({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesTeam>> getTeams({PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesServiceType.canInclude);
  ...
  Future<PcoCollection<PcoServicesTimePreferenceOption>> getTimePreferenceOptions({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  /// Available Query Filters:
  /// - `deleted`
  Future<PcoCollection<PcoServicesPlan>> getUnscopedPlans({PlanningCenterApiQuery? query, bool includeAll = false, bool includeContributors = false, bool includeMySchedules = false, bool includePlanTimes = false, bool includeSeries = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesServiceType.canInclude);
    if (includeContributors) query.include.add('contributors');
    if (includeMySchedules) query.include.add('my_schedules');
