...
class PcoServicesServiceTypeQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesServiceTypeOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesServiceTypeFilter, String> _filterMap = {
    PcoServicesServiceTypeFilter.noParent: 'no_parent',
  };
  static String filterString(PcoServicesServiceTypeFilter filter) => _filterMap[filter]!;
...
class PcoServicesServiceType extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesServiceType>> get( {String? id, PcoServicesServiceTypeQuery? query, bool includeTimePreferenceOptions = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesServiceType>> getFromFolder(String folderId, {String? id, PcoServicesServiceTypeQuery? query, bool includeTimePreferenceOptions = false,}) async {
    query ??= PcoServicesServiceTypeQuery();
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesServiceType>> getFromTeam(String teamId, {PcoServicesServiceTypeQuery? query, bool includeTimePreferenceOptions = false,}) async {
    query ??= PcoServicesServiceTypeQuery();
  ...
  Future<PcoCollection<PcoServicesItemNoteCategory>> getItemNoteCategories({PcoServicesItemNoteCategoryQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesLayout>> getLayouts({PcoServicesLayoutQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesLiveController>> getLiveControllers({PcoServicesLiveControllerQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesPlanNoteCategory>> getPlanNoteCategories({PcoServicesPlanNoteCategoryQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesPlanTemplate>> getPlanTemplates({PcoServicesPlanTemplateQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesPublicView>> getPublicView({PcoServicesPublicViewQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesTeam>> getTeams({PcoServicesTeamQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesTimePreferenceOption>> getTimePreferenceOptions({PcoServicesTimePreferenceOptionQuery? query}) async {
  ...
  /// Available Query Filters:
  /// - `deleted`
  Future<PcoCollection<PcoServicesPlan>> getUnscopedPlans({PcoServicesPlanQuery? query}) async {
    query ??= PcoServicesPlanQuery();
