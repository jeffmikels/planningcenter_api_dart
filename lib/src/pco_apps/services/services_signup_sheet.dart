/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-06-13T18:17:42.625667
...
class PcoServicesSignupSheet extends PcoResource {
  ...
  List<T> includedScheduledPeople<T extends PcoResource>() => relationships['scheduled_people']?.cast<T>() ?? [];
  List<T> includedSignupSheetMetadata<T extends PcoResource>() => relationships['signup_sheet_metadata']?.cast<T>() ?? [];
