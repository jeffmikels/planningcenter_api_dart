/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.343267
...
class PcoServicesSongQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesSongOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesSongFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesSongFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesSongQuery({
    ...
    if (whereAuthor != null) where.add(PlanningCenterApiWhere.parse('author', whereAuthor));
    if (whereCcliNumber != null) where.add(PlanningCenterApiWhere.parse('ccli_number', whereCcliNumber));
    if (whereHidden != null) where.add(PlanningCenterApiWhere.parse('hidden', whereHidden));
...
class PcoServicesSong extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesSong>> get( {String? id, PcoServicesSongQuery? query, }) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesSong>> getFromServiceTypeAndPlanAndItem(String serviceTypeId,String planId,String itemId, {String? id, PcoServicesSongQuery? query, }) async {
    query ??= PcoServicesSongQuery();
  ...
  Future<PcoCollection<PcoServicesArrangement>> getArrangements({PcoServicesArrangementQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesItem>> getLastScheduledItem({PcoServicesItemQuery? query}) async {
  ...
  /// - `three_most_recent`
  Future<PcoCollection<PcoServicesSongSchedule>> getSongSchedules({PcoServicesSongScheduleQuery? query}) async {
