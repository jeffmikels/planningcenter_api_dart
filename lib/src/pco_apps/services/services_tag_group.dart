/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:42:11.976167
...
class PcoServicesTagGroupQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesTagGroupOrder order, {bool reverse = false}) =>
  ...
  static String filterString(PcoServicesTagGroupFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesTagGroupQuery({
    ...
    if (whereTagsFor != null) where.add(PlanningCenterApiWhere.parse('tags_for', whereTagsFor));}
}
...
class PcoServicesTagGroup extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesTagGroup>> get( {String? id, PcoServicesTagGroupQuery? query, bool includeAll = false, bool includeFolder = false, bool includeTags = false,}) async {
  ...
  Future<PcoCollection<PcoServicesFolder>> getFolder({PcoServicesFolderQuery? query}) async {
