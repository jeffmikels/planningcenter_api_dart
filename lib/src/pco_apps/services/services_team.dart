/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.353909
...
class PcoServicesTeamQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesTeamOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesTeamFilter, String> _filterMap = {
    
  };
  static String filterString(PcoServicesTeamFilter filter) => _filterMap[filter]!;
  ...
  PcoServicesTeamQuery({
    ...
    if (includeAll || includePersonTeamPositionAssignments) include.add('person_team_position_assignments');
...
class PcoServicesTeam extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesTeam>> get( {String? id, PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndUpPlanAndNeededPosition(String personId,String upPlanId,String neededPositionId, {PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getSignupTeamsFromServiceTypeAndPlan(String serviceTypeId,String planId, {PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getFromServiceType(String serviceTypeId, {String? id, PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndPlanTimeAndSplitTeamRehearsalAssignment(String personId,String planTimeId,String splitTeamRehearsalAssignmentId, {PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndAssignedTeamLeader(String personId,String assignedTeamLeaderId, {PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeam>> getFromServiceTypeAndTeamPosition(String serviceTypeId,String teamPositionId, {PcoServicesTeamQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PcoServicesTeamQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  Future<PcoCollection<PcoServicesPlanPerson>> getPlanPeople({PcoServicesPlanPersonQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesTeamLeader>> getTeamLeaders({PcoServicesTeamLeaderQuery? query}) async {
  ...
  Future<PcoCollection<PcoServicesTeamPosition>> getTeamPositions({PcoServicesTeamPositionQuery? query}) async {
