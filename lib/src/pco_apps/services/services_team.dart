/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-07-28T11:29:17.615439
...
/// - Manually create an object using the `PcoServicesTeam.manual()` constructor.
...
class PcoServicesTeam extends PcoResource {
  ...
  bool get isDefaultPrepareNotifications => _attributes[kDefaultPrepareNotifications] == true;
  ...
  /// pass `null` to remove key from attributes
  set isRehearsalTeam(bool? x) => (x == null) ? _attributes.remove(kRehearsalTeam) : _attributes[kRehearsalTeam] = x;
  
  /// This determines whether a team is a split team or not.Accepted values: 1. "plan" (default) 2. "time" (designates as a split team)
  
  /// pass `null` to remove key from attributes
  set scheduleTo(String? x) => (x == null) ? _attributes.remove(kScheduleTo) : _attributes[kScheduleTo] = x;
  
  /// pass `null` to remove key from attributes
  set archivedAt(DateTime? x) => (x == null) ? _attributes.remove(kArchivedAt) : _attributes[kArchivedAt] = x.toIso8601String();
  
  /// pass `null` to remove key from attributes
  set isAssignedDirectly(bool? x) => (x == null) ? _attributes.remove(kAssignedDirectly) : _attributes[kAssignedDirectly] = x;
  
  /// pass `null` to remove key from attributes
  set stageColor(String? x) => (x == null) ? _attributes.remove(kStageColor) : _attributes[kStageColor] = x;
  
  /// pass `null` to remove key from attributes
  set stageVariant(String? x) => (x == null) ? _attributes.remove(kStageVariant) : _attributes[kStageVariant] = x;
  
  // typed getters for each relationship
  
  List<PcoServicesPerson> get includedPeople => (relationships['people'] as List?)?.cast<PcoServicesPerson>() ?? [];
  List<PcoServicesPersonTeamPositionAssignment> get includedPersonTeamPositionAssignments => (relationships['person_team_position_assignments'] as List?)?.cast<PcoServicesPersonTeamPositionAssignment>() ?? [];
  ...
  List<PcoServicesTeamPosition> get includedTeamPositions => (relationships['team_positions'] as List?)?.cast<PcoServicesTeamPosition>() ?? [];

  // Class Constructors
  PcoServicesTeam.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesTeam({required String serviceTypeId, String? id, String? name, bool? isRehearsalTeam, int? sequence, String? scheduleTo, String? defaultStatus, bool? isDefaultPrepareNotifications, DateTime? createdAt, DateTime? updatedAt, DateTime? archivedAt, bool? isAssignedDirectly, bool? isSecureTeam, String? lastPlanFrom, String? stageColor, String? stageVariant, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    ...
    if (isRehearsalTeam != null) obj._attributes['rehearsal_team'] = isRehearsalTeam;
    if (sequence != null) obj._attributes['sequence'] = sequence;
    if (scheduleTo != null) obj._attributes['schedule_to'] = scheduleTo;
    if (defaultStatus != null) obj._attributes['default_status'] = defaultStatus;
    if (isDefaultPrepareNotifications != null) obj._attributes['default_prepare_notifications'] = isDefaultPrepareNotifications;
    if (createdAt != null) obj._attributes['created_at'] = createdAt.toIso8601String();
    if (updatedAt != null) obj._attributes['updated_at'] = updatedAt.toIso8601String();
    if (archivedAt != null) obj._attributes['archived_at'] = archivedAt.toIso8601String();
    if (isAssignedDirectly != null) obj._attributes['assigned_directly'] = isAssignedDirectly;
  ...
  static Future<PcoCollection<PcoServicesTeam>> get( {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndUpPlanAndNeededPosition(String personId,String upPlanId,String neededPositionId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
    ...
    if (includeTeamLeaders) query.include.add('team_leaders');
    if (includeTeamPositions) query.include.add('team_positions');
    var url = '/services/v2/people/$personId/next_up_plans/$upPlanId/needed_positions/$neededPositionId/team';
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndPlanPerson(String personId,String planPersonId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  static Future<PcoCollection<PcoServicesTeam>> getSignupTeamsFromServiceTypeAndPlan(String serviceTypeId,String planId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndSchedule(String personId,String scheduleId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromServiceType(String serviceTypeId, {String? id, PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndPlanTimeAndSplitTeamRehearsalAssignment(String personId,String planTimeId,String splitTeamRehearsalAssignmentId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
    ...
    if (includeTeamLeaders) query.include.add('team_leaders');
    if (includeTeamPositions) query.include.add('team_positions');
    var url = '/services/v2/people/$personId/next_plan_time/$planTimeId/split_team_rehearsal_assignments/$splitTeamRehearsalAssignmentId/team';
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromPersonAndAssignedTeamLeader(String personId,String assignedTeamLeaderId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
    ...
    if (includeTeamLeaders) query.include.add('team_leaders');
    if (includeTeamPositions) query.include.add('team_positions');
    var url = '/services/v2/people/$personId/assigned_team_leaders/$assignedTeamLeaderId/team';
  ...
  static Future<PcoCollection<PcoServicesTeam>> getFromServiceTypeAndTeamPosition(String serviceTypeId,String teamPositionId, {PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includePersonTeamPositionAssignments = false, bool includeServiceType = false, bool includeTeamLeaders = false, bool includeTeamPositions = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includePersonTeamPositionAssignments) query.include.add('person_team_position_assignments');
  ...
  Future<PcoCollection<PcoServicesPerson>> getPeople({PlanningCenterApiQuery? query, }) async {
    query ??= PlanningCenterApiQuery();
  ...
  Future<PcoCollection<PcoServicesPlanPerson>> getPlanPeople({PlanningCenterApiQuery? query, bool includeAll = false, bool includeDeclinedPlanTimes = false, bool includePerson = false, bool includePlan = false, bool includeTeam = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
  ...
  Future<PcoCollection<PcoServicesTeamLeader>> getTeamLeaders({PlanningCenterApiQuery? query, bool includeAll = false, bool includePeople = false, bool includeTeam = false,}) async {
    query ??= PlanningCenterApiQuery();
    if (includeAll) query.include.addAll(PcoServicesTeam.canInclude);
    if (includePeople) query.include.add('people');
    if (includeTeam) query.include.add('team');
  ...
  Future<PcoCollection<PcoServicesTeamPosition>> getTeamPositions({PlanningCenterApiQuery? query, bool includeTeam = false,}) async {
    query ??= PlanningCenterApiQuery();
