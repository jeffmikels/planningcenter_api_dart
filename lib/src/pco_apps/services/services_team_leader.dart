...
class PcoServicesTeamLeaderQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesTeamLeaderOrder order, {bool reverse = false}) =>
...
class PcoServicesTeamLeader extends PcoResource {
  ...
  bool get isSendResponsesForAccepts => _attributes[kSendResponsesForAccepts] == true;
  bool get isSendResponsesForDeclines => _attributes[kSendResponsesForDeclines] == true;
  bool get isSendResponsesForBlockouts => _attributes[kSendResponsesForBlockouts] == true;
  ...
  // Class Constructors
  PcoServicesTeamLeader.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoServicesTeamLeader({String? id, bool? isSendResponsesForAccepts, bool? isSendResponsesForDeclines, bool? isSendResponsesForBlockouts, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
    var obj = PcoServicesTeamLeader.empty();
    obj._id = id;
    if (isSendResponsesForAccepts != null) obj._attributes['send_responses_for_accepts'] = isSendResponsesForAccepts;
    if (isSendResponsesForDeclines != null) obj._attributes['send_responses_for_declines'] = isSendResponsesForDeclines;
    if (isSendResponsesForBlockouts != null) obj._attributes['send_responses_for_blockouts'] = isSendResponsesForBlockouts;
  ...
  static Future<PcoCollection<PcoServicesTeamLeader>> getFromPerson(String personId, {String? id, PcoServicesTeamLeaderQuery? query, bool includeAll = false, bool includePeople = false, bool includeTeam = false,}) async {
  ...
  /// Additional options may be specified by using the `query` argument, but some
  /// query options are also available as boolean flags in this function call too.
  static Future<PcoCollection<PcoServicesTeamLeader>> getFromTeam(String teamId, {String? id, PcoServicesTeamLeaderQuery? query, bool includeAll = false, bool includePeople = false, bool includeTeam = false,}) async {
    query ??= PcoServicesTeamLeaderQuery();
    if (includeAll) query.include.addAll(PcoServicesTeamLeader.canInclude);
    if (includePeople) query.include.add('people');
    if (includeTeam) query.include.add('team');
