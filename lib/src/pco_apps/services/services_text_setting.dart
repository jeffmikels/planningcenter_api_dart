/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T18:03:47.518757
...
class PcoServicesTextSettingQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoServicesTextSettingOrder order,
          {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoServicesTextSettingFilter, String> _filterMap = {};
  static String filterString(PcoServicesTextSettingFilter filter) =>
      _filterMap[filter]!;
