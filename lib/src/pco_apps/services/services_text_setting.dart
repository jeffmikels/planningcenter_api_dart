/// This file was generated on 2021-11-25T00:07:20.308821
...
class PcoServicesTextSetting extends PcoResource {
  ...
  static Future<PcoCollection<PcoServicesTextSetting>> getManyFromPeopleAndTextSetting(String peopleId, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
  ...
  /// using a path like this: https://api.planningcenteronline.com/services/v2/people/1/text_settings;
  static Future<PcoCollection<PcoServicesTextSetting>> getSingleFromPeopleAndTextSetting(String peopleId, String id, {PlanningCenterApiQuery? query, bool allIncludes = false}) async {
    query ??= PlanningCenterApiQuery();
    if (allIncludes) query.include = PcoServicesTextSetting.canInclude;
