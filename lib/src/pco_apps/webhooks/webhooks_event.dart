/// =========================================================================
/// AUTO-GENERATED FILE CREATED ON 2022-10-20T17:29:04.596437
...
class PcoWebhooksEventQuery extends PlanningCenterApiQuery {
  ...
  static String orderString(PcoWebhooksEventOrder order, {bool reverse = false}) =>
      (reverse ? '-' : '') + _orderMap[order]!;

  static final Map<PcoWebhooksEventFilter, String> _filterMap = {
    
  };
  static String filterString(PcoWebhooksEventFilter filter) => _filterMap[filter]!;
...
class PcoWebhooksEvent extends PcoResource {
  ...
  // Class Constructors
  PcoWebhooksEvent.fromJson(Map<String, dynamic> data, {List<Map<String, dynamic>>? withIncluded}): super.fromJson(kPcoApplication, kTypeString, data, withIncluded: withIncluded);
  ...
  factory PcoWebhooksEvent({String? id, DateTime? createdAt, DateTime? updatedAt, String? uuid, String? payload, Map<String, List<PcoResource>>? withRelationships, List<PcoResource>? withIncluded }) {
  ...
  static Future<PcoCollection<PcoWebhooksEvent>> getFromSubscription(String subscriptionId, {String? id, PcoWebhooksEventQuery? query, }) async {
  ...
  Future<PcoCollection<PcoWebhooksDelivery>> getDeliveries({PcoWebhooksDeliveryQuery? query}) async {
